...
__all__ = ['AlignFeatures', 'CalculateTransformationErrors', 'Densify', 'EdgematchFeatures', 'ErasePoint', 'ExtendLine', 'FlipLine', 'Generalize', 'GenerateEdgematchLinks', 'GenerateRubbersheetLinks', 'RubbersheetFeatures', 'SimplifyByStraightLinesAndCircularArcs', 'Snap', 'SplitLineByMatch', 'TransferAttributes', 'TransformFeatures', 'TrimLine', 'UpdateCOGO']
__alias__ = ...
@gptooldoc('Densify_edit', None)
def Densify(in_features=..., densification_method=..., distance=..., max_deviation=..., max_angle=..., max_vertex_per_segment=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ErasePoint(in_features=..., remove_features=..., operation_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExtendLine(in_features=..., length=..., extend_to=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FlipLine(in_features=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Generalize(in_features=..., tolerance=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SimplifyByStraightLinesAndCircularArcs(in_features=..., max_offset=..., fitting_type=..., circular_arcs=..., max_arc_angle_step=..., min_vertex_count=..., min_radius=..., max_radius=..., min_arc_angle=..., closed_ends=..., anchor_points=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Snap(in_features=..., snap_environment=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TrimLine(in_features=..., dangle_length=..., delete_shorts=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpdateCOGO(in_line_features=..., distances_type=..., distance_tolerance=..., direction_type=..., minimum_direction_difference=..., minimum_direction_lateral_offset=..., combined_scale_factor=..., direction_offset=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AlignFeatures(in_features=..., target_features=..., search_distance=..., match_fields=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CalculateTransformationErrors(in_link_features=..., out_link_table=..., method=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def EdgematchFeatures(in_features=..., in_link_features=..., method=..., adjacent_features=..., border_features=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateEdgematchLinks(source_features=..., adjacent_features=..., out_feature_class=..., search_distance=..., match_fields=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateRubbersheetLinks(source_features=..., target_features=..., out_feature_class=..., search_distance=..., match_fields=..., out_match_table=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RubbersheetFeatures(in_features=..., in_link_features=..., in_identity_links=..., method=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SplitLineByMatch(in_features=..., matched_features=..., in_match_table=..., out_feature_class=..., search_distance=..., in_features_as=..., out_point_feature_class=..., split_dangle=..., min_match_group_length=..., min_split_length=..., split_fields=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TransferAttributes(source_features=..., target_features=..., transfer_fields=..., search_distance=..., match_fields=..., out_match_table=..., transfer_rule_fields=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TransformFeatures(in_features=..., in_link_features=..., method=..., out_link_table=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
