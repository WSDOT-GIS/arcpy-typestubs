...
various formats."""
__all__ = ['ASCIIToRaster', 'AddCADFields', 'AddRasterToGeoPackage', 'BIMFileToGeodatabase', 'CADToGeodatabase', 'ConnectNetworkDatasetTransitSourcesToStreets', 'ConvertLas', 'DEMToRaster', 'ExcelToTable', 'ExportCAD', 'ExportFeatures', 'ExportTable', 'ExtractLocationsDocument', 'ExtractLocationsText', 'FeatureClassToFeatureClass', 'FeatureClassToGeodatabase', 'FeatureClassToShapefile', 'FeatureToRaster', 'FeaturesToGPX', 'FeaturesToGTFSShapes', 'FeaturesToGTFSStops', 'FeaturesToGraphics', 'FeaturesToJSON', 'FloatToRaster', 'GPXtoFeatures', 'GTFSShapesToFeatures', 'GTFSStopsToFeatures', 'GTFSToNetworkDatasetTransitSources', 'GenerateShapesFeaturesFromGTFS', 'GraphicsToFeatures', 'JSONToFeatures', 'KMLToLayer', 'LasDatasetToRaster', 'LayerToKML', 'MapToKML', 'MobileGdbToFileGdb', 'MultipatchToCollada', 'MultipatchToRaster', 'PDFToTIFF', 'PointCloudToRaster', 'PointToRaster', 'PolygonToRaster', 'PolylineToRaster', 'RasterToASCII', 'RasterToFloat', 'RasterToGeodatabase', 'RasterToOtherFormat', 'RasterToPoint', 'RasterToPolygon', 'RasterToPolyline', 'SASToTable', 'TableToDBASE', 'TableToExcel', 'TableToGeodatabase', 'TableToSAS', 'TableToTable', 'WFSToFeatureClass']
__alias__ = ...
@gptooldoc('ConnectNetworkDatasetTransitSourcesToStreets_conversion', None)
def ConnectNetworkDatasetTransitSourcesToStreets(target_feature_dataset=..., in_streets_features=..., search_distance=..., expression=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GTFSToNetworkDatasetTransitSources(in_gtfs_folders=..., target_feature_dataset=..., interpolate=..., append=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExcelToTable(Input_Excel_File=..., Output_Table=..., Sheet=..., field_names_row=..., cell_range=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TableToExcel(Input_Table=..., Output_Excel_File=..., Use_field_alias_as_column_header=..., Use_domain_and_subtype_description=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PDFToTIFF(in_pdf_file=..., out_tiff_file=..., pdf_password=..., pdf_page_number=..., pdf_map=..., clip_option=..., resolution=..., color_mode=..., tiff_compression=..., geotiff_tags=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RasterToASCII(in_raster=..., out_ascii_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RasterToFloat(in_raster=..., out_float_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RasterToPoint(in_raster=..., out_point_features=..., raster_field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RasterToPolygon(in_raster=..., out_polygon_features=..., simplify=..., raster_field=..., create_multipart_features=..., max_vertices_per_feature=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RasterToPolyline(in_raster=..., out_polyline_features=..., background_value=..., minimum_dangle_length=..., simplify=..., raster_field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def WFSToFeatureClass(input_WFS_server=..., WFS_feature_type=..., out_path=..., out_name=..., is_complex=..., max_features=..., expose_metadata=..., swap_xy=..., page_size=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FeaturesToGPX(in_features=..., out_gpx_file=..., name_field=..., description_field=..., z_field=..., date_field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GPXtoFeatures(Input_GPX_File=..., Output_Feature_class=..., Output_Type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FeaturesToGraphics(in_layer=..., out_layer=..., exclude_features=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GraphicsToFeatures(in_layer=..., graphics_type=..., out_feature_class=..., delete_graphics=..., reference_scale=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FeaturesToJSON(in_features=..., out_json_file=..., format_json=..., include_z_values=..., include_m_values=..., geoJSON=..., outputToWGS84=..., use_field_alias=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def JSONToFeatures(in_json_file=..., out_features=..., geometry_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def KMLToLayer(in_kml_file=..., output_folder=..., output_data=..., include_groundoverlay=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ConvertLas(in_las=..., target_folder=..., file_version=..., point_format=..., compression=..., las_options=..., out_las_dataset=..., define_coordinate_system=..., in_coordinate_system=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def LasDatasetToRaster(in_las_dataset=..., out_raster=..., value_field=..., interpolation_type=..., data_type=..., sampling_type=..., sampling_value=..., z_factor=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PointCloudToRaster(in_point_cloud=..., cell_size=..., out_raster=..., cell_assignment=..., void_fill=..., z_factor=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SASToTable(in_sas_dataset=..., out_table=..., use_cas_connection=..., hostname=..., port=..., username=..., password=..., custom_cfg_file=..., authinfo_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TableToSAS(in_table=..., out_sas_dataset=..., replace_sas_dataset=..., use_domain_and_subtype_description=..., use_cas_connection=..., hostname=..., port=..., username=..., password=..., custom_cfg_file=..., authinfo_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddCADFields(input_table=..., Entities=..., LayerProps=..., TextProps=..., DocProps=..., XDataProps=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportCAD(in_features=..., Output_Type=..., Output_File=..., Ignore_FileNames=..., Append_To_Existing=..., Seed_File=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MultipatchToCollada(in_features=..., output_folder=..., prepend_source=..., field_name=..., collada_version=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddRasterToGeoPackage(in_dataset=..., target_geopackage=..., raster_name=..., tiling_scheme=..., tiling_scheme_file=..., area_of_interest=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def BIMFileToGeodatabase(in_bim_file_workspace=..., out_gdb_path=..., out_dataset_name=..., spatial_reference=..., identifier=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CADToGeodatabase(input_cad_datasets=..., out_gdb_path=..., out_dataset_name=..., reference_scale=..., spatial_reference=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportFeatures(in_features=..., out_features=..., where_clause=..., use_field_alias_as_name=..., field_mapping=..., sort_field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportTable(in_table=..., out_table=..., where_clause=..., use_field_alias_as_name=..., field_mapping=..., sort_field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExtractLocationsText(in_text=..., out_feature_class=..., in_template=..., coord_dd_latlon=..., coord_dd_xydeg=..., coord_dd_xyplain=..., coord_dm_latlon=..., coord_dm_xymin=..., coord_dms_latlon=..., coord_dms_xysec=..., coord_dms_xysep=..., coord_utm=..., coord_ups_north=..., coord_ups_south=..., coord_mgrs=..., coord_mgrs_northpolar=..., coord_mgrs_southpolar=..., comma_decimal=..., coord_use_lonlat=..., in_coor_system=..., in_custom_locations=..., fuzzy_match=..., max_features_extracted=..., ignore_first_features=..., date_monthname=..., date_m_d_y=..., date_yyyymmdd=..., date_yymmdd=..., date_yyjjj=..., max_dates_extracted=..., ignore_first_dates=..., date_range_begin=..., date_range_end=..., in_custom_attributes=..., file_link=..., file_mod_datetime=..., pre_text_length=..., post_text_length=..., std_coord_fmt=..., req_word_breaks=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FeatureClassToFeatureClass(in_features=..., out_path=..., out_name=..., where_clause=..., field_mapping=..., config_keyword=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FeatureClassToGeodatabase(Input_Features=..., Output_Geodatabase=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MobileGdbToFileGdb(in_mobile_gdb=..., out_file_gdb=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RasterToGeodatabase(Input_Rasters=..., Output_Geodatabase=..., Configuration_Keyword=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TableToGeodatabase(Input_Table=..., Output_Geodatabase=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TableToTable(in_rows=..., out_path=..., out_name=..., where_clause=..., field_mapping=..., config_keyword=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ASCIIToRaster(in_ascii_file=..., out_raster=..., data_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DEMToRaster(in_dem_file=..., out_raster=..., data_type=..., z_factor=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FeatureToRaster(in_features=..., field=..., out_raster=..., cell_size=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FloatToRaster(in_float_file=..., out_raster=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MultipatchToRaster(in_multipatch_features=..., out_raster=..., cell_size=..., cell_assignment_method=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PointToRaster(in_features=..., value_field=..., out_rasterdataset=..., cell_assignment=..., priority_field=..., cellsize=..., build_rat=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PolygonToRaster(in_features=..., value_field=..., out_rasterdataset=..., cell_assignment=..., priority_field=..., cellsize=..., build_rat=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PolylineToRaster(in_features=..., value_field=..., out_rasterdataset=..., cell_assignment=..., priority_field=..., cellsize=..., build_rat=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RasterToOtherFormat(Input_Rasters=..., Output_Workspace=..., Raster_Format=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FeatureClassToShapefile(Input_Features=..., Output_Folder=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TableToDBASE(Input_Table=..., Output_Folder=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
