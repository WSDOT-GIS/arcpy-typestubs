...
def AddNetworkAttribute(
    in_trace_network=..., attribute_name=..., attribute_type=..., is_nullable=...
...
def ConvertGeometricNetworkToTraceNetwork(
    in_geometric_network=..., out_trace_network_name=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def EnableNetworkTopology(
    in_trace_network=..., max_number_of_errors=..., only_generate_errors=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetFlowDirection(
    input_trace_network=..., in_edges=..., flow_direction=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetNetworkAttribute(
    in_trace_network=..., network_attribute=..., featureclass=..., field=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DeleteTraceConfiguration(
    in_trace_network=..., trace_config_name=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportTraceConfigurations(
    in_trace_network=..., trace_config_name=..., out_json_file=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
