...
class DirectionsQuery:
    ...
    def adjacentEdges(self, junction: TraversedJunction) -> Iterable[AdjacentNetworkEdge] | None:
...
class TraversedJunction(TraversedElement):
    ...
    def getName(self, index: int = ..., mapping: DirectionsFieldMapping = ..., fallback: str = ...) -> str | None:
    ...
    def getNames(self, mapping: DirectionsFieldMapping = ..., fallback: str = ...) -> Iterable[str] | None:
