...
RANGE_RE = ...
def page_range_list(range_string): # -> list[Unknown]:
    ...
...
class PDFDocument:
    ...
    def insertPages(self, pdf_path, before_page_number=..., input_pdf_password=...): # -> None:
    ...
    def updateDocProperties(self, pdf_title=..., pdf_author=..., pdf_subject=..., pdf_keywords=..., pdf_open_view=..., pdf_layout=...): # -> None:
    ...
    def updateDocSecurity(self, new_master_password, new_user_password=..., encryption=...): # -> None:
...
def PDFDocumentOpen(pdf_path, user_password=..., master_password=...): # -> PDFDocument:
