...
def ConfigureIndoorPositioning(
    in_geodatabase=..., encryption_key=..., api_key=..., building_id=...
...
def CreateIndoor3DDataset(
    target_gdb=..., indoor_dataset_name=..., spatial_reference=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ClassifyIndoorPathways(
    in_unit_features=..., target_pathways=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateIndoorNetworkDataset(
    target_gdb=..., indoor_network_dataset_name=..., spatial_reference=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
