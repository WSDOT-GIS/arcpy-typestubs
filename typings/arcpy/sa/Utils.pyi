...
class StateSwapper:
    ...
    def __call__(self, wrapper): # -> (*args: Unknown, **kwargs: Unknown) -> Unknown:
        ...
...
def multiValueCompoundParameterToString(parameter, cls): # -> LiteralString | str | list[Unknown]:
    """
...
def argumentValueEqualsString(argument, string): # -> Literal[False]:
    ...

def useDefaultArgumentValue(argument): # -> bool:
    ...
