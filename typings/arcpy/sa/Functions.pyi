...
def AddSurfaceInformation(in_feature_class, in_surface, out_property, method=..., sample_distance=..., z_factor=..., pyramid_level_resolution=..., noise_filtering=...): # -> Any:
...
def Aggregate(in_raster, cell_factor, aggregation_type=..., extent_handling=..., ignore_nodata=...):
...
def AggregateMultidimensionalRaster(in_multidimensional_raster, dimension, aggregation_method=..., variables=..., aggregation_def=..., interval_keyword=..., interval_value=..., interval_unit=..., interval_ranges=..., aggregation_function=..., ignore_nodata=..., dimensionless=..., percentile_value=..., percentile_interpolation_type=...):
...
def Aspect(in_raster, method=..., z_unit=..., project_geodesic_azimuths=..., analysis_target_device=...):
...
def BandCollectionStats(in_raster_bands, out_stat_file, compute_matrices=...): # -> Any:
...
def BlockStatistics(in_raster, neighborhood=..., statistics_type=..., ignore_nodata=...):
...
def CalculateKernelDensityRatio(in_features_numerator, in_features_denominator, population_field_numerator, population_field_denominator, cell_size=..., search_radius_numerator=..., search_radius_denominator=..., out_cell_values=..., method=..., in_barriers_numerator=..., in_barriers_denominator=...):
...
def CellStatistics(in_rasters_or_constants, statistics_type=..., ignore_nodata=..., process_as_multiband=..., percentile_value=..., percentile_interpolation_type=...):
...
def ClassProbability(in_raster_bands, in_signature_file, maximum_output_value=..., a_priori_probabilities=..., in_a_priori_file=...):
...
def ComputeConfusionMatrix(in_accuracy_assessment_points, out_confusion_matrix): # -> Any:
...
def ComputeSegmentAttributes(in_segmented_raster, in_additional_raster=..., used_attributes=...):
...
def Con(in_conditional_raster, in_true_raster_or_constant, in_false_raster_or_constant=..., where_clause=...):
...
def Contour(in_raster, out_polyline_features, contour_interval, base_contour=..., z_factor=..., contour_type=..., max_vertices_per_feature=...): # -> Any:
...
def ContourWithBarriers(in_raster, out_contour_feature_class, in_barrier_features=..., in_contour_type=..., in_contour_values_file=..., explicit_only=..., in_base_contour=..., in_contour_interval=..., in_indexed_contour_interval=..., in_explicit_contours=..., in_z_factor=...): # -> Any:
...
def CostAllocation(in_source_data, in_cost_raster, maximum_distance=..., in_value_raster=..., source_field=..., out_distance_raster=..., out_backlink_raster=..., source_cost_multiplier=..., source_start_cost=..., source_resistance_rate=..., source_capacity=..., source_direction=...):
...
def CostBackLink(in_source_data, in_cost_raster, maximum_distance=..., out_distance_raster=..., source_cost_multiplier=..., source_start_cost=..., source_resistance_rate=..., source_capacity=..., source_direction=...):
...
def CostConnectivity(in_regions, in_cost_raster, out_feature_class, out_neighbor_paths=...): # -> Any:
...
def CostDistance(in_source_data, in_cost_raster, maximum_distance=..., out_backlink_raster=..., source_cost_multiplier=..., source_start_cost=..., source_resistance_rate=..., source_capacity=..., source_direction=...):
...
def CostPath(in_destination_data, in_cost_distance_raster, in_cost_backlink_raster, path_type=..., destination_field=..., force_flow_direction_convention=...):
...
def CostPathAsPolyline(in_destination_data, in_cost_distance_raster, in_cost_backlink_raster, out_polyline_features, path_type=..., destination_field=..., force_flow_direction_convention=...): # -> Any:
...
def CreateAccuracyAssessmentPoints(in_class_data, out_points, target_field=..., num_random_points=..., sampling=..., polygon_dimension_field=...): # -> Any:
...
def CreateSignatures(in_raster_bands, in_sample_data, out_signature_file, compute_covariance=..., sample_field=...): # -> Any:
...
def Curvature(in_raster, z_factor=..., out_profile_curve_raster=..., out_plan_curve_raster=...):
...
def DarcyFlow(in_head_raster, in_porosity_raster, in_thickness_raster, in_transmissivity_raster, out_direction_raster=..., out_magnitude_raster=...):
...
def DeepLearningModelToEcd(in_deep_learning_model, in_classification_info_json, out_classifier_definition): # -> Any:
...
def Dendrogram(in_signature_file, out_dendrogram_file, distance_calculation=..., line_width=...): # -> Any:
...
def DeriveContinuousFlow(in_surface_raster, in_depressions_data=..., in_weight_raster=..., out_flow_direction_raster=..., flow_direction_type=..., force_flow=...):
...
def DeriveStreamAsLine(in_surface_raster, out_stream_features, in_depressions_data=..., in_weight_raster=..., accumulation_threshold=..., stream_designation_method=..., simplify=...): # -> Any:
...
def DeriveStreamAsRaster(in_surface_raster, in_depressions_data=..., in_weight_raster=..., accumulation_threshold=..., stream_designation_method=..., force_flow=...):
...
def DimensionalMovingStatistics(in_raster, dimension=..., backward_window=..., forward_window=..., nodata_handling=..., statistics_type=..., percentile_value=..., percentile_interpolation_type=..., circular_wrap_value=...):
...
def DistanceAccumulation(in_source_data, in_barrier_data=..., in_surface_raster=..., in_cost_raster=..., in_vertical_raster=..., vertical_factor=..., in_horizontal_raster=..., horizontal_factor=..., out_back_direction_raster=..., out_source_direction_raster=..., out_source_location_raster=..., source_initial_accumulation=..., source_maximum_accumulation=..., source_cost_multiplier=..., source_direction=..., distance_method=...):
...
def EditSignatures(in_raster_bands, in_signature_file, in_signature_remap_file, out_signature_file, sample_interval=...): # -> Any:
...
def EucAllocation(in_source_data, maximum_distance=..., in_value_raster=..., cell_size=..., source_field=..., out_distance_raster=..., out_direction_raster=..., distance_method=..., in_barrier_data=..., out_back_direction_raster=...):
...
def EucBackDirection(in_source_data, in_barrier_data=..., maximum_distance=..., cell_size=..., distance_method=...):
...
def EucDirection(in_source_data, maximum_distance=..., cell_size=..., out_distance_raster=..., distance_method=..., in_barrier_data=..., out_back_direction_raster=...):
...
def EucDistance(in_source_data, maximum_distance=..., cell_size=..., out_direction_raster=..., distance_method=..., in_barrier_data=..., out_back_direction_raster=...):
...
def ExtractMultiValuesToPoints(in_point_features, in_rasters, bilinear_interpolate_values=...): # -> Any:
...
def ExtractValuesToPoints(in_point_features, in_raster, out_point_features, interpolate_values=..., add_attributes=...): # -> Any:
...
def FlowAccumulation(in_flow_direction_raster, in_weight_raster=..., data_type=..., flow_direction_type=...):
...
def FlowDirection(in_surface_raster, force_flow=..., out_drop_raster=..., flow_direction_type=...):
...
def FlowDistance(in_stream_raster, in_surface_raster, in_flow_direction_raster=..., distance_type=..., flow_direction_type=..., statistics_type=...):
...
def FlowLength(in_flow_direction_raster, direction_measurement=..., in_weight_raster=...):
...
def FocalStatistics(in_raster, neighborhood=..., statistics_type=..., ignore_nodata=..., percentile_value=...):
...
def GenerateMultidimensionalAnomaly(in_multidimensional_raster, variables=..., method=..., calculation_interval=..., ignore_nodata=..., reference_mean_raster=...):
...
def GenerateTrainingSamplesFromSeedPoints(in_class_data, in_seed_points, out_training_feature_class, min_sample_area=..., max_sample_radius=...): # -> Any:
...
def GeomorphonLandforms(in_surface_raster, out_geomorphons_raster=..., angle_threshold=..., distance_units=..., search_distance=..., skip_distance=..., z_unit=...):
...
def Idw(in_point_features, z_field, cell_size=..., power=..., search_radius=..., in_barrier_polyline_features=...):
...
def InspectTrainingSamples(in_raster, in_training_features, in_classifier_definition, out_training_feature_class, in_additional_raster=...):
...
def InterpolateShape(in_surface, in_feature_class, out_feature_class, sample_distance=..., z_factor=..., method=..., vertices_only=..., pyramid_level_resolution=..., preserve_features=...): # -> Any:
...
def IsoCluster(in_raster_bands, out_signature_file, number_classes, number_iterations=..., min_class_size=..., sample_interval=...): # -> Any:
...
def IsoClusterUnsupervisedClassification(in_raster_bands, Number_of_classes, Minimum_class_size=..., Sample_interval=..., out_signature_file=...):
...
def KernelDensity(in_features, population_field, cell_size=..., search_radius=..., area_unit_scale_factor=..., out_cell_values=..., method=..., in_barriers=...):
...
def Kriging(in_point_features, z_field, kriging_model, cell_size=..., search_radius=..., out_variance_prediction_raster=...):
...
def LeastCostCorridor(in_accumulative_cost_distance_raster1, in_back_direction_raster1, in_accumulative_cost_distance_raster2, in_back_direction_raster2, threshold_method=..., threshold=...):
...
def LineDensity(in_polyline_features, population_field, cell_size=..., search_radius=..., area_unit_scale_factor=...):
...
def LineStatistics(in_polyline_features, field, cell_size=..., search_radius=..., statistics_type=...):
...
def MLClassify(in_raster_bands, in_signature_file, reject_fraction=..., a_priori_probabilities=..., in_a_priori_file=..., out_confidence_raster=...):
...
def Nibble(in_raster, in_mask_raster, nibble_values=..., nibble_nodata=..., in_zone_raster=...):
...
def ObserverPoints(in_raster, in_observer_point_features, z_factor=..., curvature_correction=..., refractivity_coefficient=..., out_agl_raster=...):
...
def OptimalPathAsLine(in_destination_data, in_distance_accumulation_raster, in_back_direction_raster, out_polyline_features, destination_field=..., path_type=..., create_network_paths=...): # -> Any:
...
def OptimalPathAsRaster(in_destination_data, in_distance_accumulation_raster, in_back_direction_raster, destination_field=..., path_type=...):
...
def OptimalRegionConnections(in_regions, out_feature_class, in_barrier_data=..., in_cost_raster=..., out_neighbor_paths=..., distance_method=..., connections_within_regions=...): # -> Any:
...
def ParticleTrack(in_direction_raster, in_magnitude_raster, source_point, out_track_file, step_length=..., tracking_time=..., out_track_polyline_features=...): # -> Any:
...
def PathAllocation(in_source_data, in_cost_raster=..., in_surface_raster=..., in_horizontal_raster=..., horizontal_factor=..., in_vertical_raster=..., vertical_factor=..., maximum_distance=..., in_value_raster=..., source_field=..., out_distance_raster=..., out_backlink_raster=..., source_cost_multiplier=..., source_start_cost=..., source_resistance_rate=..., source_capacity=..., source_direction=...):
...
def PathBackLink(in_source_data, in_cost_raster=..., in_surface_raster=..., in_horizontal_raster=..., horizontal_factor=..., in_vertical_raster=..., vertical_factor=..., maximum_distance=..., out_distance_raster=..., source_cost_multiplier=..., source_start_cost=..., source_resistance_rate=..., source_capacity=..., source_direction=...):
...
def PathDistance(in_source_data, in_cost_raster=..., in_surface_raster=..., in_horizontal_raster=..., horizontal_factor=..., in_vertical_raster=..., vertical_factor=..., maximum_distance=..., out_backlink_raster=..., source_cost_multiplier=..., source_start_cost=..., source_resistance_rate=..., source_capacity=..., source_direction=...):
...
def PointDensity(in_point_features, population_field, cell_size=..., neighborhood=..., area_unit_scale_factor=...):
...
def PointStatistics(in_point_features, field, cell_size=..., neighborhood=..., statistics_type=...):
...
def PorousPuff(in_track_file, in_porosity_raster, in_thickness_raster, mass, dispersion_time=..., longitudinal_dispersivity=..., dispersivity_ratio=..., retardation_factor=..., decay_coefficient=...):
...
def ReclassByTable(in_raster, in_remap_table, from_value_field, to_value_field, output_value_field, missing_values=...):
...
def RegionGroup(in_raster, number_neighbors=..., zone_connectivity=..., add_link=..., excluded_value=...):
...
def RemoveRasterSegmentTilingArtifacts(in_segmented_raster, tileSizeX=..., tileSizeY=...):
...
def RescaleByFunction(in_raster, transformation_function=..., from_scale=..., to_scale=...):
...
def Sample(in_rasters, in_location_data, out_table, resampling_type=..., unique_id_field=..., process_as_multidimensional=..., acquisition_definition=..., statistics_type=..., percentile_value=..., buffer_distance=..., layout=..., generate_feature_class=...): # -> Any:
...
def SegmentMeanShift(in_raster, spectral_detail=..., spatial_detail=..., min_segment_size=..., band_indexes=..., max_segment_size=...):
...
def Slice(in_raster, number_zones=..., slice_type=..., base_output_zone=..., nodata_to_value=..., class_interval_size=...):
...
def Slope(in_raster, output_measurement=..., z_factor=..., method=..., z_unit=..., analysis_target_device=...):
...
def SnapPourPoint(in_pour_point_data, in_accumulation_raster, snap_distance, pour_point_field=...):
...
def SolarRadiationGraphics(in_surface_raster, in_points_feature_or_table=..., sky_size=..., height_offset=..., calculation_directions=..., latitude=..., time_configuration=..., day_interval=..., hour_interval=..., out_sunmap_raster=..., zenith_divisions=..., azimuth_divisions=..., out_skymap_raster=...):
...
def Spline(in_point_features, z_field, cell_size=..., spline_type=..., weight=..., number_points=...):
...
def SplineWithBarriers(in_point_features, Z_value_field, Input_barrier_features=..., cell_size=..., Smoothing_Factor=...):
...
def StorageCapacity(in_surface_raster, out_table, in_zone_data=..., zone_field=..., analysis_type=..., min_elevation=..., max_elevation=..., increment_type=..., increment=..., z_unit=..., out_chart=...): # -> Any:
...
def StreamToFeature(in_stream_raster, in_flow_direction_raster, out_polyline_features, simplify=...): # -> Any:
...
def SurfaceParameters(in_raster, parameter_type=..., local_surface_type=..., neighborhood_distance=..., use_adaptive_neighborhood=..., z_unit=..., output_slope_measurement=..., project_geodesic_azimuths=..., use_equatorial_aspect=..., in_analysis_mask=...):
...
def TabulateArea(in_zone_data, zone_field, in_class_data, class_field, out_table, processing_cell_size=..., classes_as_rows=...): # -> Any:
...
def Thin(in_raster, background_value=..., filter=..., corners=..., maximum_thickness=...):
...
def TopoToRasterByFile(in_parameter_file, out_stream_features=..., out_sink_features=..., out_residual_feature=..., out_stream_cliff_error_feature=..., out_contour_error_feature=...):
...
def TrainIsoClusterClassifier(in_raster, max_classes, out_classifier_definition, in_additional_raster=..., max_iterations=..., min_samples_per_cluster=..., skip_factor=..., used_attributes=..., max_merge_per_iter=..., max_merge_distance=...): # -> Any:
...
def TrainKNearestNeighborClassifier(in_raster, in_training_features, out_classifier_definition, in_additional_raster=..., kNN=..., max_samples_per_class=..., used_attributes=..., dimension_value_field=...): # -> Any:
...
def TrainMaximumLikelihoodClassifier(in_raster, in_training_features, out_classifier_definition, in_additional_raster=..., used_attributes=..., dimension_value_field=...): # -> Any:
...
def TrainRandomTreesClassifier(in_raster, in_training_features, out_classifier_definition, in_additional_raster=..., max_num_trees=..., max_tree_depth=..., max_samples_per_class=..., used_attributes=..., dimension_value_field=...): # -> Any:
...
def TrainSupportVectorMachineClassifier(in_raster, in_training_features, out_classifier_definition, in_additional_raster=..., max_samples_per_class=..., used_attributes=..., dimension_value_field=...): # -> Any:
...
def Trend(in_point_features, z_field, cell_size=..., order=..., regression_type=..., out_rms_file=...):
...
def UpdateAccuracyAssessmentPoints(in_class_data, in_points, out_points, target_field=..., polygon_dimension_field=..., point_dimension_field=...): # -> Any:
...
def Viewshed(in_raster, in_observer_features, z_factor=..., curvature_correction=..., refractivity_coefficient=..., out_agl_raster=...):
...
def ZonalGeometryAsTable(in_zone_data, zone_field, out_table, processing_cell_size=...): # -> Any:
...
def ZonalHistogram(in_zone_data, zone_field, in_value_raster, out_table, out_graph=..., zones_as_rows=...): # -> Any:
...
def ZonalStatistics(in_zone_data, zone_field, in_value_raster, statistics_type=..., ignore_nodata=..., process_as_multidimensional=..., percentile_value=..., percentile_interpolation_type=..., circular_calculation=..., circular_wrap_value=...):
...
def ZonalStatisticsAsTable(in_zone_data, zone_field, in_value_raster, out_table, ignore_nodata=..., statistics_type=..., process_as_multidimensional=..., percentile_values=..., percentile_interpolation_type=..., circular_calculation=..., circular_wrap_value=...): # -> Any:
