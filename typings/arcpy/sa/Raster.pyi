...
def tryLocalFunction(*args): # -> tuple[Raster, Literal[True]] | tuple[None, Literal[False]]:
...
class Raster(arcgisscripting.Raster):
  ...
  def exportImage(self, width=..., height=..., format=..., extent=..., spatial_reference=..., mosaic_rule=...): # -> Image:
    """ export an image
  ...
  def addDimension(self, variable, new_dimension_name, dimension_value, dimension_attributes=...):
  ...
  def read(self, upper_left_corner=..., origin_coordinate=..., ncols=..., nrows=..., nodata_to_value=..., cell_size=...): # -> ndarray:
    """
  ...
  def write(self, array, upper_left_corner=..., origin_coordinate=..., value_to_nodata=...):
    """
