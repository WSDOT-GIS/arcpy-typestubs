...
__all__ = ['AddAngleDirectedLayout', 'AddCollapseContainerByAttributeRule', 'AddCollapseContainerRule', 'AddCompressionLayout', 'AddConnectivityAssociationsRule', 'AddDiagramFeatureCapabilityByAttributeRule', 'AddDiagramTemplate', 'AddDomainNetwork', 'AddExpandContainerByAttributeRule', 'AddExpandContainerRule', 'AddForceDirectedLayout', 'AddGridLayout', 'AddLinearDispatchLayout', 'AddMainRingLayout', 'AddMainlineTreeLayout', 'AddNetworkAttribute', 'AddNetworkCategory', 'AddPartialOverlappingEdgesLayout', 'AddRadialTreeLayout', 'AddReduceEdgeByAttributeRule', 'AddReduceJunctionByAttributeRule', 'AddReduceJunctionRule', 'AddRelativeMainlineLayout', 'AddRemoveFeatureByAttributeRule', 'AddRemoveFeatureRule', 'AddReshapeDiagramEdgesLayout', 'AddRule', 'AddSetRootJunctionByAttributeRule', 'AddSetStartingPointByAttributeRule', 'AddSmartTreeLayout', 'AddSpatialDispatchLayout', 'AddSpatialQueryRule', 'AddStartIterationRule', 'AddStopIterationRule', 'AddStructuralAttachmentsRule', 'AddTerminalConfiguration', 'AddTier', 'AddTierGroup', 'AddTraceConfiguration', 'AddTraceLocations', 'AddTraceRule', 'AlterDiagramProperties', 'AlterDiagramTemplate', 'AppendToDiagram', 'ApplyAngleDirectedLayout', 'ApplyCompressionLayout', 'ApplyForceDirectedLayout', 'ApplyGeoPositionsLayout', 'ApplyGridLayout', 'ApplyLinearDispatchLayout', 'ApplyMainRingLayout', 'ApplyMainlineTreeLayout', 'ApplyPartialOverlappingEdgesLayout', 'ApplyRadialTreeLayout', 'ApplyRelativeMainlineLayout', 'ApplyRotateTreeLayout', 'ApplySmartTreeLayout', 'ApplySpatialDispatchLayout', 'ApplyTemplateLayouts', 'ChangeDiagramsOwner', 'CreateDiagram', 'CreateDiagramLayerDefinition', 'CreateUtilityNetwork', 'DeleteDiagram', 'DeleteDiagramTemplate', 'DeleteNetworkCategory', 'DeleteRule', 'DeleteTerminalConfiguration', 'DeleteTraceConfiguration', 'DisableNetworkTopology', 'EnableNetworkTopology', 'ExportAssociations', 'ExportDiagramContent', 'ExportDiagramLayerDefinition', 'ExportDiagramTemplateDefinitions', 'ExportRules', 'ExportSubnetwork', 'ExportSubnetworkControllers', 'ExportTraceConfigurations', 'ExtendDiagram', 'GetDiagramTemplateNames', 'ImportAssociations', 'ImportDiagramTemplateDefinitions', 'ImportRules', 'ImportSubnetworkControllers', 'ImportTraceConfigurations', 'MakeDiagramLayer', 'OverwriteDiagram', 'PurgeTemporaryDiagrams', 'RepairNetworkTopology', 'ReshapeDiagramEdgesLayout', 'SetAssociationRole', 'SetEdgeConnectivity', 'SetNetworkAttribute', 'SetNetworkCategory', 'SetSubnetworkDefinition', 'SetTerminalConfiguration', 'StoreDiagram', 'Trace', 'UpdateDiagram', 'UpdateIsConnected', 'UpdateSubnetwork', 'UpdateUtilityNetworkSchema', 'ValidateNetworkTopology', 'VerifyNetworkTopology']
__alias__ = ...
...
def AddTraceLocations(in_utility_network=..., out_feature_class=..., load_selected_features=..., clear_trace_locations=..., trace_locations=..., filter_barrier=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RepairNetworkTopology(in_utility_network=..., out_log_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpdateIsConnected(in_utility_network=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpdateSubnetwork(in_utility_network=..., domain_network=..., tier=..., all_subnetworks_in_tier=..., subnetwork_name=..., continue_on_failure=..., condition_barriers=..., function_barriers=..., include_barriers=..., traversability_scope=..., propagators=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpdateUtilityNetworkSchema(in_utility_network=..., operations=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ValidateNetworkTopology(in_utility_network=..., extent=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def VerifyNetworkTopology(in_utility_network=..., out_log_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddDomainNetwork(in_utility_network=..., domain_network_name=..., tier_definition=..., subnetwork_controller_type=..., domain_network_alias_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddNetworkAttribute(in_utility_network=..., attribute_name=..., attribute_type=..., is_inline=..., is_apportionable=..., domain=..., is_overridable=..., is_nullable=..., is_substitution=..., network_attribute_to_substitute=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddNetworkCategory(in_utility_network=..., category_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddRule(in_utility_network=..., rule_type=..., from_class=..., from_assetgroup=..., from_assettype=..., to_class=..., to_assetgroup=..., to_assettype=..., from_terminal=..., to_terminal=..., via_class=..., via_assetgroup=..., via_assettype=..., via_terminal=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddTerminalConfiguration(in_utility_network=..., terminal_configuration_name=..., traversability_model=..., terminals_directional=..., terminals_bidirectional=..., valid_paths=..., default_path=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddTier(in_utility_network=..., domain_network=..., name=..., rank=..., topology_type=..., tier_group_name=..., subnetwork_field_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddTierGroup(in_utility_network=..., domain_network=..., name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateUtilityNetwork(in_feature_dataset=..., in_utility_network_name=..., service_territory_feature_class=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DeleteNetworkCategory(in_utility_network=..., category_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DeleteRule(in_utility_network=..., rule_type=..., rule_desc=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DeleteTerminalConfiguration(in_utility_network=..., terminal_configuration_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DisableNetworkTopology(in_utility_network=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def EnableNetworkTopology(in_utility_network=..., max_number_of_errors=..., only_generate_errors=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportAssociations(in_utility_network=..., association_type=..., out_csv_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportRules(in_utility_network=..., rule_type=..., out_csv_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportSubnetworkControllers(in_utility_network=..., out_csv_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportAssociations(in_utility_network=..., association_type=..., csv_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportRules(in_utility_network=..., rule_type=..., csv_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportSubnetworkControllers(in_utility_network=..., csv_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetAssociationRole(in_utility_network=..., domain_network=..., featureclass=..., assetgroup=..., assettype=..., association_role_type=..., association_deletion_semantics=..., view_scale=..., split_content=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetEdgeConnectivity(in_utility_network=..., domain_network=..., line_featureclass=..., assetgroup=..., assettype=..., edge_connectivity=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetNetworkAttribute(in_utility_network=..., network_attribute=..., domain_network=..., featureclass=..., field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetNetworkCategory(in_utility_network=..., domain_network=..., featureclass=..., assetgroup=..., assettype=..., category=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetTerminalConfiguration(in_utility_network=..., domain_network=..., device_featureclass=..., assetgroup=..., assettype=..., terminal_configuration=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddTraceConfiguration(in_utility_network=..., trace_config_name=..., trace_type=..., description=..., tags=..., domain_network=..., tier=..., target_tier=..., subnetwork_name=..., shortest_path_network_attribute_name=..., include_containers=..., include_content=..., include_structures=..., include_barriers=..., validate_consistency=..., condition_barriers=..., function_barriers=..., traversability_scope=..., filter_barriers=..., filter_function_barriers=..., filter_scope=..., filter_bitset_network_attribute_name=..., filter_nearest=..., nearest_count=..., nearest_cost_network_attribute=..., nearest_categories=..., nearest_assets=..., functions=..., propagators=..., output_assettypes=..., output_conditions=..., include_isolated_features=..., ignore_barriers_at_starting_points=..., include_up_to_first_spatial_container=..., result_types=..., allow_indeterminate_flow=..., validate_locatability=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DeleteTraceConfiguration(in_utility_network=..., trace_config_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportTraceConfigurations(in_utility_network=..., trace_config_name=..., out_json_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportTraceConfigurations(in_utility_network=..., in_json_file=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
