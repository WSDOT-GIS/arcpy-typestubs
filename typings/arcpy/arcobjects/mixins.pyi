...
wildcardmatch = ...
__all__ = ['SupportsPropertyMixin', 'ArrayMixin', 'CursorMixin', 'GeometrySpecializationMixin', 'LayoutElementSpecializationMixin', 'LayerSymbologySpecializationMixin', 'RasterClassifiedExclusionMixin', 'LayerIterationMixin', 'LayerMixin', 'TableViewMixin', 'ImageFileExportMixin', 'DataFrameMixin', 'MapDocumentMixin', 'PointMixin', 'ResultMixin']
pagesize_tuple = ...
bookmark_tuple = ...
webmap_tuple = ...
excludedvalues_re = ...
...
class ArrayMixin:
    ...
    def __getitem__(self, key): # -> ArrayMixin | conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
...
class GeometrySpecializationMixin:
    ...
    @classmethod
    def __from_scripting_arc_object__(cls, obj): # -> _passthrough:
        ...
    ...
    def __add__(self, other): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    
    def __or__(self, other): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    
    def __sub__(self, other): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    
    def __xor__(self, other): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    
    def __reduce__(self): # -> tuple[(byte_array: Unknown, spatial_reference: Unknown | None = None) -> (Unknown | conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]), tuple[Unknown | Any, Unknown]]:
        ...
    
    def __iter__(self): # -> Generator[Unknown | Any, Any, None]:
        ...
    
    def __getitem__(self, key): # -> list[Unknown | conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]] | conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
...
class ParameterMixin:
    def __init__(self, name=..., displayName=..., direction=..., datatype=..., parameterType=..., enabled=..., category=..., symbology=..., multiValue=...) -> None:
...
class RasterClassifiedExclusionMixin:
    ...
    def excludedValues(self, value): # -> None:
        ...
...
class ImageFileExportMixin:
    ...
    def exportToAI(self, out_ai, df_export_width=..., df_export_height=..., resolution=..., image_quality=..., colorspace=..., picture_symbol=..., convert_markers=...):
        ...
    
    def exportToBMP(self, out_bmp, df_export_width=..., df_export_height=..., resolution=..., world_file=..., color_mode=..., rle_compression=..., background_mask_color=...):
        ...
    
    def exportToEMF(self, out_emf, df_export_width=..., df_export_height=..., resolution=..., image_quality=..., description=..., picture_symbol=..., convert_markers=...):
        ...
    
    def exportToEPS(self, out_eps, df_export_width=..., df_export_height=..., resolution=..., image_quality=..., colorspace=..., ps_lang_level=..., image_compression=..., picture_symbol=..., convert_markers=..., embed_fonts=..., page_layout_image=..., page_layout_emulsion=..., jpeg_compression_quality=...):
        ...
    
    def exportToGIF(self, out_gif, df_export_width=..., df_export_height=..., resolution=..., world_file=..., color_mode=..., gif_compression=..., background_color=..., transparent_color=..., interlaced=...):
        ...
    
    def exportToJPEG(self, out_jpeg, df_export_width=..., df_export_height=..., resolution=..., world_file=..., color_mode=..., jpeg_quality=..., background_color=..., progressive=...):
        ...
    
    def exportToPDF(self, out_pdf, df_export_width=..., df_export_height=..., resolution=..., image_quality=..., colorspace=..., compress_vectors=..., image_compression=..., picture_symbol=..., convert_markers=..., embed_fonts=..., layers_attributes=..., georef_info=..., jpeg_compression_quality=...):
        ...
    
    def exportToPNG(self, out_png, df_export_width=..., df_export_height=..., resolution=..., world_file=..., color_mode=..., background_color=..., transparent_color=..., interlaced=...):
        ...
    
    def exportToSVG(self, out_svg, df_export_width=..., df_export_height=..., resolution=..., image_quality=..., compress_document=..., picture_symbol=..., convert_markers=..., embed_fonts=...):
        ...
    
    def exportToTIFF(self, out_tiff, df_export_width=..., df_export_height=..., resolution=..., world_file=..., color_mode=..., tiff_compression=..., geoTIFFTags=...):
        ...
...
class MapDocumentMethods:
    ...
    @property
    def dataDrivenPages(self): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    
    @property
    def isDDPEnabled(self): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
...
class MapDocumentMixin(ImageFileExportMixin):
    ...
    def __getitem__(self, search_layer): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    
    @property
    def pageLayout(self): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    
    @property
    def layers(self): # -> list[Unknown]:
        ...
    
    @property
    def layerNames(self): # -> list[Unknown]:
        ...
    
    @property
    def dataFrames(self): # -> list[Unknown] | map[Unknown | conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]]:
        ...
    
    @property
    def dataFrameNames(self): # -> list[Unknown]:
        ...
    
    def listLayoutElements(self, element_type=..., wildcard=...): # -> list[Unknown]:
        ...
    
    def listTextElements(self, wildcard=...): # -> list[Unknown]:
        ...
    ...
    @property
    def textElements(self): # -> list[Unknown]:
        ...
    
    def listDataFrames(self, wildcard=...): # -> list[Unknown] | list[Unknown | conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]]:
        ...
    ...
    def containsLayer(self, layer_name): # -> bool:
        ...
    ...
    def saveToLayerFile(self, layer, out_file, version=...): # -> None:
        ...
    ...
    def analyzeForMSD(self): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    


class ArcSDESQLExecuteMixin:
    def __init__(self, server=..., instance=..., database=..., user=..., password=...) -> None:
...
class SpatialReferenceMixin:
    ...
    def __reduce__(self): # -> tuple[Type[SpatialReference], tuple[None, None, Unknown]]:
        ...
