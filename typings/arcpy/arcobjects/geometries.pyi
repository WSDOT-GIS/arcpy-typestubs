...
class Multipoint(Geometry):
    ...
    @property
    def __geo_interface__(self): # -> dict[str, Unknown]:
        ...
...
class PointGeometry(Geometry):
    ...
    def toCoordString(self, notation): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
class Polyline(Geometry):
    ...
    def __getSVG__(self, scale_factor=..., stroke_color=...): # -> LiteralString | Literal['<g />']:
...
def AsShape(geojson_struct, esri_json=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FromCoordString(coordinate_str, notation): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateOptimalCoordinateSystem(extent, property, custom_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
