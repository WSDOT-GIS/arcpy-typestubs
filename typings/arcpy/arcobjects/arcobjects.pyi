...
from arcpy import PointGeometry, Polygon
...
class PointAndDistanceTuple(NamedTuple):
    """
    A tuple containing the following:

    * A PointGeometry object that is the nearest point on the polyline to the in_point.
    ...
    * A Boolean that indicates whether the in_point is on the right side of the line.
      The direction of the line determines the right and left sides.
    """

    NearestPoint: PointGeometry
    DistanceBetweenLineStartPointAndPointOnLine: float
    MinumumDistanceBetweenLineAndInputPoint: float
    PointIsOnRightSideOfLine: bool
...
class Geometry(mixins.GeometrySpecializationMixin, _BaseArcObject):
    ...
    def queryPointAndDistance(
        self, in_point: PointGeometry | Point, use_percentage: bool | None = None
    ) -> PointAndDistanceTuple:
        ...
        Returns a tuple that includes the following:
            ...
            * The distance between the start point of the line and the returned point on the line.
            * The minimum distance between the line and the in_point.
            * A Boolean that indicates whether the in_point is on the right side of the line. The direction of the line determines the right and left sides.
...
class Result(mixins.ResultMixin, _BaseArcObject):
    ...
    def getMessage(self, index: int) -> str:
        ...
        ...
    def getMessages(self, severity: Literal[0, 1, 2] | None = None) -> Iterable[str]:
