...
def indent_text(astring, indentation=...): ...
def indent_unicode_text(astring, indentation=...): ...
...
def docstring_for_tool(
    tool,
):  # -> Generator[LiteralString | Unknown | Literal['', '     INPUTS:', '     OUTPUTS:'], Any, None]:
    """Builds the documentation string for an individual tool"""
    ...

def function_name_for_tool(tool, alt_alias=..., use_alt_alias=...): ...
def code_for_tool(
    tool, include_add_toolbox=..., alt_alias=..., use_alt_alias=...
):  # -> Generator[str | LiteralString | Unknown, Any, None]:
