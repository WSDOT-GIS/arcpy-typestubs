...
def AverageNearestNeighbor(
    Input_Feature_Class=..., Distance_Method=..., Generate_Report=..., Area=...
...
def CalculateAreas(
    Input_Feature_Class=..., Output_Feature_Class=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CalculateDistanceBand(
    Input_Features=..., Neighbors=..., Distance_Method=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CollectEvents(
    Input_Incident_Features=..., Output_Weighted_Point_Feature_Class=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ConvertSpatialWeightsMatrixtoTable(
    Input_Spatial_Weights_Matrix_File=..., Output_Table=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
