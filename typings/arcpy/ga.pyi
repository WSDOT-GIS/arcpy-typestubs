...
__all__ = ['ArealInterpolationLayerToPolygons', 'CompareGeostatisticalLayers', 'CreateSpatiallyBalancedPoints', 'CrossValidation', 'DensifySamplingNetwork', 'DiffusionInterpolationWithBarriers', 'EBKRegressionPrediction', 'EmpiricalBayesianKriging', 'EmpiricalBayesianKriging3D', 'ExploratoryInterpolation', 'ExtractValuesToTable', 'GACalculateZValue', 'GACreateGeostatisticalLayer', 'GAGetModelParameter', 'GALayer3DToMultidimensionalRaster', 'GALayer3DToNetCDF', 'GALayerToContour', 'GALayerToGrid', 'GALayerToPoints', 'GALayerToRasters', 'GAMovingWindowKriging', 'GANeighborhoodSelection', 'GASemivariogramSensitivity', 'GASetModelParameter', 'GaussianGeostatisticalSimulations', 'GenerateSubsetPolygons', 'GlobalPolynomialInterpolation', 'IDW', 'KernelInterpolationWithBarriers', 'LocalPolynomialInterpolation', 'NearestNeighbor3D', 'RadialBasisFunctions', 'SubsetFeatures']
__alias__ = ...
__all__ += _ga.__all__
@gptooldoc('DiffusionInterpolationWithBarriers_ga', None)
def DiffusionInterpolationWithBarriers(in_features=..., z_field=..., out_ga_layer=..., out_raster=..., cell_size=..., in_barrier_features=..., bandwidth=..., number_iterations=..., weight_field=..., in_additive_barrier_raster=..., in_cumulative_barrier_raster=..., in_flow_barrier_raster=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def EBKRegressionPrediction(in_features=..., dependent_field=..., in_explanatory_rasters=..., out_ga_layer=..., out_raster=..., out_diagnostic_feature_class=..., measurement_error_field=..., min_cumulative_variance=..., in_subset_features=..., transformation_type=..., semivariogram_model_type=..., max_local_points=..., overlap_factor=..., number_simulations=..., search_neighborhood=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def EmpiricalBayesianKriging(in_features=..., z_field=..., out_ga_layer=..., out_raster=..., cell_size=..., transformation_type=..., max_local_points=..., overlap_factor=..., number_semivariograms=..., search_neighborhood=..., output_type=..., quantile_value=..., threshold_type=..., probability_threshold=..., semivariogram_model_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def EmpiricalBayesianKriging3D(in_features=..., elevation_field=..., value_field=..., out_ga_layer=..., elevation_units=..., measurement_error_field=..., semivariogram_model_type=..., transformation_type=..., subset_size=..., overlap_factor=..., number_simulations=..., trend_removal=..., elev_inflation_factor=..., search_neighborhood=..., output_elevation=..., output_type=..., quantile_value=..., threshold_type=..., probability_threshold=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GAMovingWindowKriging(in_ga_model_source=..., in_datasets=..., in_locations=..., neighbors_max=..., out_featureclass=..., cell_size=..., out_surface_grid=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GlobalPolynomialInterpolation(in_features=..., z_field=..., out_ga_layer=..., out_raster=..., cell_size=..., power=..., weight_field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def IDW(in_features=..., z_field=..., out_ga_layer=..., out_raster=..., cell_size=..., power=..., search_neighborhood=..., weight_field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def KernelInterpolationWithBarriers(in_features=..., z_field=..., out_ga_layer=..., out_raster=..., cell_size=..., in_barrier_features=..., kernel_function=..., bandwidth=..., power=..., ridge=..., output_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def LocalPolynomialInterpolation(in_features=..., z_field=..., out_ga_layer=..., out_raster=..., cell_size=..., power=..., search_neighborhood=..., kernel_function=..., bandwidth=..., use_condition_number=..., condition_number=..., weight_field=..., output_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def NearestNeighbor3D(in_features=..., category_field=..., out_netcdf_file=..., x_spacing=..., y_spacing=..., elevation_spacing=..., elev_inflation_factor=..., in_study_area=..., min_elev_raster=..., max_elev_raster=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RadialBasisFunctions(in_features=..., z_field=..., out_ga_layer=..., out_raster=..., cell_size=..., search_neighborhood=..., radial_basis_functions=..., small_scale_parameter=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateSpatiallyBalancedPoints(in_probability_raster=..., number_output_points=..., out_feature_class=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DensifySamplingNetwork(in_geostat_layer=..., number_output_points=..., out_feature_class=..., selection_criteria=..., threshold=..., in_weight_raster=..., in_candidate_point_features=..., inhibition_distance=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExtractValuesToTable(in_features=..., in_rasters=..., out_table=..., out_raster_names_table=..., add_warning_field=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CompareGeostatisticalLayers(in_geostat_layers=..., out_cv_table=..., out_geostat_layer=..., comparison_method=..., criterion=..., criteria_hierarchy=..., weighted_criteria=..., exclusion_criteria=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CrossValidation(in_geostat_layer=..., out_point_feature_class=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExploratoryInterpolation(in_features=..., value_field=..., out_cv_table=..., out_geostat_layer=..., interp_methods=..., comparison_method=..., criterion=..., criteria_hierarchy=..., weighted_criteria=..., exclusion_criteria=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GANeighborhoodSelection(in_dataset=..., out_layer=..., point_coord=..., neighbors_max=..., neighbors_min=..., minor_semiaxis=..., major_semiaxis=..., angle=..., shape_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GASemivariogramSensitivity(in_ga_model_source=..., in_datasets=..., in_locations=..., nugget_span_percents=..., nugget_calc_times=..., partialsill_span_percents=..., partialsill_calc_times=..., range_span_percents=..., range_calc_times=..., minrange_span_percents=..., minrange_calc_times=..., out_table=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateSubsetPolygons(in_point_features=..., out_feature_class=..., min_points_per_subset=..., max_points_per_subset=..., coincident_points=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SubsetFeatures(in_features=..., out_training_feature_class=..., out_test_feature_class=..., size_of_training_dataset=..., subset_size_units=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ArealInterpolationLayerToPolygons(in_areal_interpolation_layer=..., in_polygon_features=..., out_feature_class=..., append_all_fields=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GACalculateZValue(in_geostat_layer=..., point_coord=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GACreateGeostatisticalLayer(in_ga_model_source=..., in_datasets=..., out_layer=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GAGetModelParameter(in_ga_model_source=..., model_param_xpath=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GALayer3DToMultidimensionalRaster(in_3d_geostat_layer=..., out_multidimensional_raster=..., cell_size=..., explicit_only=..., min_elev=..., max_elev=..., elev_interval=..., elev_values=..., elev_units=..., output_type=..., quantile_probability_value=..., additional_outputs=..., build_transpose=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GALayer3DToNetCDF(in_3d_geostat_layers=..., out_netcdf_file=..., export_locations=..., x_spacing=..., y_spacing=..., elevation_spacing=..., in_points_3d=..., output_variables=..., in_study_area=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GALayerToContour(in_geostat_layer=..., contour_type=..., out_feature_class=..., contour_quality=..., classification_type=..., classes_count=..., classes_breaks=..., out_elevation=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GALayerToGrid(in_geostat_layer=..., out_surface_grid=..., cell_size=..., points_per_block_horz=..., points_per_block_vert=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GALayerToPoints(in_geostat_layer=..., in_locations=..., z_field=..., out_feature_class=..., append_all_fields=..., elevation_field=..., elevation_units=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GALayerToRasters(in_geostat_layer=..., out_raster=..., output_type=..., quantile_probability_value=..., cell_size=..., points_per_block_horz=..., points_per_block_vert=..., additional_rasters=..., out_elevation=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GASetModelParameter(in_ga_model_source=..., model_param_xpath=..., in_param_value=..., out_ga_model=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
