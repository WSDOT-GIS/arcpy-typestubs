...
__all__ = ['AnalyzeControlPoints', 'AppendControlPoints', 'ApplyBlockAdjustment', 'ComputeBlockAdjustment', 'ComputeCameraModel', 'ComputeControlPoints', 'ComputeTiePoints', 'ExportFrameAndCameraParameters', 'GenerateBlockAdjustmentReport', 'MatchControlPoints', 'ReconstructSurface']
__alias__ = ...
@gptooldoc('AnalyzeControlPoints_rm', None)
def AnalyzeControlPoints(in_mosaic_dataset=..., in_control_points=..., out_coverage_table=..., out_overlap_table=..., in_mask_dataset=..., minimum_area=..., maximum_level=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AppendControlPoints(in_master_control_points=..., in_input_control_points=..., in_z_field=..., in_tag_field=..., in_dem=..., in_xy_accuracy=..., in_z_accuracy=..., Geoid=..., area_of_interest=..., append_option=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ApplyBlockAdjustment(in_mosaic_dataset=..., adjustment_operation=..., input_solution_table=..., pan_to_ms_scaling_factor=..., DEM=..., zoffset=..., control_point_table=..., adjust_footprints=..., solution_point_table=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ComputeBlockAdjustment(in_mosaic_dataset=..., in_control_points=..., transformation_type=..., out_solution_table=..., out_solution_point_table=..., maximum_residual_value=..., adjustment_options=..., location_accuracy=..., out_quality_table=..., DEM=..., elevation_accuracy=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ComputeCameraModel(in_mosaic_dataset=..., out_dsm=..., gps_accuracy=..., estimate=..., refine=..., apply_adjustment=..., maximum_residual=..., initial_tiepoint_resolution=..., out_control_points=..., out_solution_table=..., out_solution_point_table=..., out_flight_path=..., maximum_overlap=..., minimum_coverage=..., remove=..., in_control_points=..., options=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ComputeControlPoints(in_mosaic_dataset=..., in_reference_images=..., out_control_points=..., similarity=..., out_image_feature_points=..., density=..., distribution=..., area_of_interest=..., location_accuracy=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ComputeTiePoints(in_mosaic_dataset=..., out_control_points=..., similarity=..., in_mask_dataset=..., out_image_features=..., density=..., distribution=..., location_accuracy=..., options=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportFrameAndCameraParameters(input_mosaic_dataset=..., output_file=..., output_format=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateBlockAdjustmentReport(input_mosaic_dataset=..., input_solution_table=..., input_solution_point=..., output_report=..., input_control_point_for_adjustment=..., report_format=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MatchControlPoints(in_mosaic_dataset=..., in_control_points=..., out_control_points=..., similarity=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ReconstructSurface(in_mosaic_dataset=..., recon_folder=..., recon_options=..., scenario=..., fwd_overlap=..., swd_overlap=..., quality=..., products=..., cell_size=..., aoi=..., waterbody_features=..., correction_features=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
