...
def CalculateIntersectingRouteMeasures(
    in_intersection_feature_class=..., out_dataset=..., tvd=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateRoutes(
    in_route_features=..., record_calibration_changes=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RemoveLRSEntity(
    in_workspace=..., lrs_entity_type=..., lrs_entity_name=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ModifyRouteIdPadding(
    in_feature_class=..., route_id_padding=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
