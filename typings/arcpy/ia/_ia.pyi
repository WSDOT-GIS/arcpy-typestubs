...
def Aggregate(in_raster, dimension_name, raster_function, raster_function_arguments=..., aggregation_definition=..., dimensionless=...):
...
def Anomaly(in_raster, dimension_name=..., anomaly_type=..., temporal_interval=..., ignore_nodata=...):
