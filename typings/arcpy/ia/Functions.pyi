...
__all__ = ["Abs", "ACos", "ACosH", "AggregateMultidimensionalRaster", "AnalyzeChangesUsingCCDC", "AnalyzeChangesUsingLandTrendr", "ApplyGeometricTerrainCorrection", "ApplyOrbitCorrection", "ApplyRadiometricCalibration", "ApplyRadiometricTerrainFlattening", "ASin", "ASinH", "ATan", "ATan2", "ATanH", "BitwiseAnd", "BitwiseLeftShift", "BitwiseNot", "BitwiseOr", "BitwiseRightShift", "BitwiseXOr", "BooleanAnd", "BooleanNot", "BooleanOr", "BooleanXOr", "CellStatistics", "ClassifyObjectsUsingDeepLearning", "ClassifyPixelsUsingDeepLearning", "ClassifyRaster", "ClassifyRasterUsingSpectra", "CombinatorialAnd", "CombinatorialOr", "CombinatorialXOr", "ComputeAccuracyForObjectDetection", "ComputeChangeRaster", "ComputeConfusionMatrix", "ComputeSegmentAttributes", "Con", "ConvertSARUnits", "Cos", "CosH", "CreateAccuracyAssessmentPoints", "CreateColorComposite", "DeepLearningModelToEcd", "Despeckle", "DetectChangeUsingChangeAnalysisRaster", "DetectChangeUsingDeepLearning", "DetectObjectsUsingDeepLearning", "Diff", "DimensionalMovingStatistics", "Divide", "DownloadOrbitFile", "EqualTo", "Exp", "Exp10", "Exp2", "ExportTrainingDataForDeepLearning", "ExtractFeaturesUsingAIModels", "ExtractVideoFramesToImages", "FindArgumentStatistics", "Float", "FocalStatistics", "GenerateMultidimensionalAnomaly", "GenerateTrainingSamplesFromSeedPoints", "GenerateTrendRaster", "GreaterThan", "GreaterThanEqual", "InList", "InspectTrainingSamples", "Int", "InterpolateFromSpatiotemporalPoints", "IsNull", "LessThan", "LessThanEqual", "LinearSpectralUnmixing", "Ln", "Log10", "Log2", "Minus", "Mod", "MultidimensionalPrincipalComponents", "Negate", "NonMaximumSuppression", "NotEqual", "Over", "Pick", "Plus", "Power", "PredictUsingRegressionModel", "PredictUsingTrendRaster", "RemoveRasterSegmentTilingArtifacts", "RemoveThermalNoise", "RoundDown", "RoundUp", "Sample", "SegmentMeanShift", "SetNull", "Sin", "SinH", "Square", "SquareRoot", "SummarizeCategoricalRaster", "Tan", "TanH", "Test", "Times", "TrainDeepLearningModel", "TrainIsoClusterClassifier", "TrainKNearestNeighborClassifier", "TrainMaximumLikelihoodClassifier", "TrainRandomTreesClassifier", "TrainRandomTreesRegressionModel", "TrainSupportVectorMachineClassifier", "TrainUsingAutoDL", "UpdateAccuracyAssessmentPoints", "VideoMetadataToFeatureClass", "VideoMultiplexer", "WeightedSum", "ZonalStatistics", "ZonalStatisticsAsTable", "ApplyEnvironment", "FloatDivide", "FloorDivide"]
...
def AnalyzeChangesUsingCCDC(in_multidimensional_raster, bands=..., tmask_bands=..., chi_squared_threshold=..., min_anomaly_observations=..., update_frequency=...):
...
def AnalyzeChangesUsingLandTrendr(in_multidimensional_raster, processing_band=..., snapping_date=..., max_num_segments=..., vertex_count_overshoot=..., spike_threshold=..., recovery_threshold=..., prevent_one_year_recovery=..., recovery_trend=..., min_num_observations=..., best_model_proportion=..., pvalue_threshold=..., output_other_bands=...):
...
def ApplyGeometricTerrainCorrection(in_radar_data, polarization_bands=..., in_dem_raster=..., geoid=...):
...
def ApplyRadiometricCalibration(in_radar_data, polarization_bands=..., calibration_type=...):
...
def ApplyRadiometricTerrainFlattening(in_radar_data, in_dem_raster, geoid=..., polarization_bands=..., calibration_type=..., out_scattering_area=..., out_geometric_distortion=..., out_geometric_distortion_mask=...):
...
def ClassifyObjectsUsingDeepLearning(in_raster, out_feature_class, in_model_definition, in_features=..., class_label_field=..., processing_mode=..., model_arguments=..., caption_field=...): # -> Any:
...
def ClassifyPixelsUsingDeepLearning(in_raster, in_model_definition, arguments=..., processing_mode=..., out_classified_folder=..., out_featureclass=...): # -> Any:
...
def ClassifyRasterUsingSpectra(in_raster, in_spectra_file, method=..., thresholds=..., out_score_raster=..., out_classifier_definition=...):
...
def ComputeAccuracyForObjectDetection(detected_features, ground_truth_features, out_accuracy_table, out_accuracy_report=..., detected_class_value_field=..., ground_truth_class_value_field=..., min_iou=..., mask_features=...): # -> Any:
...
def ComputeChangeRaster(from_raster, to_raster, compute_change_method=..., from_classes=..., to_classes=..., filter_method=..., define_transition_colors=..., from_classname_field=..., to_classname_field=...):
...
def Despeckle(in_radar_data, polarization_bands=..., filter_type=..., filter_size=..., noise_model=..., noise_variance=..., add_noise_mean=..., mult_noise_mean=..., number_of_looks=..., damp_factor=...):
...
def DetectChangeUsingDeepLearning(from_raster, to_raster, in_model_definition, arguments=...):
...
def DetectObjectsUsingDeepLearning(in_raster, out_detected_objects, in_model_definition, arguments=..., run_nms=..., confidence_score_field=..., class_value_field=..., max_overlap_ratio=..., processing_mode=...): # -> Any:
...
def DownloadOrbitFile(in_radar_data, orbit_type=..., username=..., password=...): # -> Any:
...
def ExtractVideoFramesToImages(in_video, out_folder, image_type=..., image_overlap=..., require_fresh_metadata=..., min_time=...): # -> Any:
...
def FindArgumentStatistics(in_raster, dimension=..., dimension_def=..., interval_keyword=..., variables=..., statistics_type=..., min=..., max=..., multiple_occurrence=..., ignore_nodata=..., value=..., comparison=..., occurrence=...):
...
def GenerateTrendRaster(in_multidimensional_raster, dimension, variables=..., line_type=..., frequency=..., ignore_nodata=..., cycle_length=..., cycle_unit=..., rmse=..., r2=..., slope_p_value=..., seasonal_period=...):
...
def MultidimensionalPrincipalComponents(in_multidimensional_raster, mode, dimension, out_pc, out_loadings, out_eigenvalues=..., variable=..., number_of_pc=...): # -> Any:
...
def NonMaximumSuppression(in_featureclass, confidence_score_field, out_featureclass, class_value_field=..., max_overlap_ratio=...): # -> Any:
...
def PredictUsingTrendRaster(in_multidimensional_raster, variables=..., dimension_def=..., dimension_values=..., start=..., end=..., interval_value=..., interval_unit=...):
...
def SummarizeCategoricalRaster(in_raster, out_table, dimension=..., aoi=..., aoi_id_field=...): # -> Any:
...
def TrainDeepLearningModel(in_folder, out_folder, max_epochs=..., model_type=..., batch_size=..., arguments=..., learning_rate=..., backbone_model=..., pretrained_model=..., validation_percentage=..., stop_training=..., freeze=...): # -> Any:
...
def TrainRandomTreesRegressionModel(in_rasters, in_target_data, out_regression_definition, target_value_field=..., target_dimension_field=..., raster_dimension=..., out_importance_table=..., max_num_trees=..., max_tree_depth=..., max_samples=..., average_points_per_cell=..., percent_testing=..., out_scatterplots=..., out_sample_features=...): # -> Any:
...
def TrainUsingAutoDL(in_data, out_model, pretrained_model=..., total_time_limit=..., autodl_mode=..., networks=..., save_evaluated_models=...): # -> Any:
...
def VideoMetadataToFeatureClass(in_video, csv_file=..., flightpath=..., flightpath_type=..., imagepath=..., imagepath_type=..., footprint=..., start_time=..., stop_time=..., min_distance=..., min_time=...): # -> Any:
...
def VideoMultiplexer(in_video_file, metadata_file, out_video_file, metadata_mapping_file=..., timeshift_file=..., elevation_layer=...): # -> Any:
