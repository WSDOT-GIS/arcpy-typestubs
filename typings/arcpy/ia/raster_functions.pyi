...
def Arithmetic(
    raster1, raster2, operation_type=..., extent_type=..., cellsize_type=...
):
    """
...
def Statistics(
    raster, kernel_columns=..., kernel_rows=..., stat_type=..., fill_no_data_only=...
):
    """
...
def RasterCalculator(
    rasters, input_names, expression, extent_type=..., cellsize_type=...
):
    """
...
def Remap(
    raster, input_ranges=..., output_values=..., no_data_ranges=..., allow_unmatched=...
):
    """
...
def Sultan(
    raster, band1_id=..., band3_id=..., band4_id=..., band5_id=..., band6_id=...
):
    """
...
def RasterizeFeatures(
    raster, feature_class, class_index_field=..., resolve_overlap_method=...
):
    """
...
def GeometricMedian(
    rasters, epsilon=..., max_iteration=..., extent_type=..., cellsize_type=...
):
    """
...
def EqualToFrequency(
    value_raster, rasters, extent_type=..., cellsize_type=..., process_as_multiband=...
):
    """
...
def Rank(
    rank_raster, rasters, extent_type=..., cellsize_type=..., process_as_multiband=...
):
    """
