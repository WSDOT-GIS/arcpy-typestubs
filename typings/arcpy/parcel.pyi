...
into parcel fabrics."""
__all__ = ['AddParcelType', 'AnalyzeParcelsByLeastSquaresAdjustment', 'AppendParcels', 'ApplyParcelLeastSquaresAdjustment', 'BuildParcelFabric', 'CopyParcels', 'CreateParcelFabric', 'CreateParcelRecords', 'DisableParcelTopology', 'EnableParcelTopology', 'ExportSequencedParcelFeatures', 'GenerateParcelFabricLinks', 'ImportParcelFabricPoints', 'MergeCollinearParcelBoundaries', 'RemoveParcelType', 'SetParcelLineLabelPosition', 'UpgradeArcMapParcelFabric', 'ValidateParcelFabric']
__alias__ = ...
@gptooldoc('AnalyzeParcelsByLeastSquaresAdjustment_parcel', None)
def AnalyzeParcelsByLeastSquaresAdjustment(in_parcel_fabric=..., analysis_type=..., convergence_tolerance=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AppendParcels(in_parcel_fabric=..., target_parcel_fabric=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ApplyParcelLeastSquaresAdjustment(in_parcel_fabric=..., movement_tolerance=..., update_attributes=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def BuildParcelFabric(in_parcel_fabric=..., extent=..., record_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CopyParcels(in_parcel_fabric=..., target_database=..., out_dataset_name=..., out_fabric_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportSequencedParcelFeatures(in_parcel_polygon_feature=..., target_feature_dataset=..., start_sequence_corner=..., points_sequence_format=..., lines_sequence_format=..., sequence_curves_separately=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateParcelFabricLinks(target_parcel_fabric=..., out_links_feature_class=..., out_anchor_points_feature_class=..., from_date=..., to_date=..., min_link_length=..., extent=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportParcelFabricPoints(source_points=..., target_parcel_fabric=..., match_point_method=..., search_distance=..., update_type=..., record_name=..., match_field=..., conflicts_table=..., update_create_option=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MergeCollinearParcelBoundaries(in_parcel_boundaries=..., offset_tolerance=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetParcelLineLabelPosition(in_parcel_features=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ValidateParcelFabric(in_parcel_fabric=..., extent=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddParcelType(in_parcel_fabric=..., name=..., administrative_polygon=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateParcelFabric(target_dataset=..., name=..., config_keyword=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateParcelRecords(in_parcel_features=..., record_field=..., record_expression=..., record_name_method=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DisableParcelTopology(in_parcel_fabric=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def EnableParcelTopology(in_parcel_fabric=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RemoveParcelType(in_parcel_fabric=..., name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpgradeArcMapParcelFabric(in_parcel_fabric=..., target_dataset=..., name=..., delete_identical=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
