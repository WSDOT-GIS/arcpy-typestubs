...
def ImportToolbox(input_file: str, module_name: Optional[str]=None) -> str | ModuleType:  # -> str | ModuleType:
...
def ListInstallations() -> list[InstallationType]:  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """ListInstallations()
...
def SetProgressor(
    type: Literal["default", "step"] , message: Optional[str]=None, min_range: Optional[int]=0, max_range: Optional[int]=100, step_value: Optional[int]=None
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetReturnCode(
    index: int,
) -> int:  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """GetReturnCode(index)
...
def AddError(
    message: str,
) -> None:  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """AddError(message)
...
def ListSpatialReferences(
    wild_card: str = None, spatial_reference_type: Literal["GCS", "PCS", "ALL"] = None
) -> list[str]:
...
def GetParameter(
    index: int,
) -> Any:  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """GetParameter(index)
...
def AddToolbox(
    input_file: str, module_name: str = ...
...
def ListFeatureClasses(
    wild_card: str = ..., feature_type: FeatureType = ..., feature_dataset: str = ...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Describe(
    value: str, data_type:Optional[Literal["FeatureLayer",
                "Table",
                "TableView",
                "Dataset",
                "FeatureDataset",
...
GPObjectType = Literal["ArcSDESQLExecute" , "Array" , "Extent" ,
...
) -> ArcSDESQLExecute | Array | Extent | FeatureSet | Field | FieldInfo | FieldMap | FieldMappings | Geometry | NetCDFFileProperties | Point | RecordSet | Result | SpatialReference | ValueTable:    """CreateObject(name, {options})
...
) -> bool:  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
