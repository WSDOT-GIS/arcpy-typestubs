...
from arcpy.geoprocessing import env, gp
...
from arcgisscripting import ClearCredentials as _ClearCredentials, ExecuteError, ExecuteWarning, ImportCredentials as _ImportCredentials, NumPyArrayToRaster as _NumPyArrayToRaster, RasterToNumPyArray as _RasterToNumPyArray, SignInToPortal as _SignInToPortal
from arcpy import metadata, mp, nax, sharing
from arcpy.charts import Chart
from arcpy.sa import Raster, RasterInfo
from arcpy.ia import Mensuration, Render
...
if local_appdata and os.path.exists(local_appdata):
    addin_toolbox_path = ...
sitepackpths = ...
def ImportToolbox(input_file, module_name=...): # -> str | ModuleType:
...
def GetInstallInfo(product=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """GetInstallInfo()
...
def GetPackageInfo(filename): # -> Any:
    """GetPackageInfo(filename)

       Return the item infomation for a given package."""
    ...

def ListInstallations(): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """ListInstallations()
...
def SetProgressor(type, message=..., min_range=..., max_range=..., step_value=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetProgressorLabel(label): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetProgressorPosition(position=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ClearEnvironment(environment_name): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetMessage(index): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """GetMessage(index)
...
def GetReturnCode(index): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """GetReturnCode(index)
...
def GetMessages(severity=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddMessage(message): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """AddMessage(message)
...
def AddIDMessage(message_type, message_ID, add_argument1=..., add_argument2=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetIDMessage(message_ID, default_message=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddError(message): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """AddError(message)
...
def AddWarning(message): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """AddWarning(message)
...
def AddReturnMessage(index): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetProduct(product): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """SetProduct(product)
...
def CheckProduct(product): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ProductInfo(): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """ProductInfo()

       Returns the current product license."""
    ...

def CheckOutExtension(extension_code): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CheckInExtension(extension_code): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CheckExtension(extension_code): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListSpatialReferences(wild_card=..., spatial_reference_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListTransformations(from_sr, to_sr, extent=..., vertical=..., first_only=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetParameterAsText(index): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetParameterAsText(index, text): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetParameter(index): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """GetParameter(index)
...
def SetParameter(index, value): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CopyParameter(from_param, to_param): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetParameterSymbology(index, text): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListFiles(wild_card=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """ListFiles({wild_card})
...
def ListTools(wild_card=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """ListTools({wild_card})
...
def ListEnvironments(wild_card=...): # -> list[Unknown]:
...
def ListToolboxes(wild_card=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddToolbox(input_file, module_name=...): # -> str | ModuleType:
...
def RemoveToolbox(toolbox): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetSystemEnvironment(environment): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Command(command_line): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Usage(tool_name): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """Usage(tool_name)
...
def Exists(dataset): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """Exists(dataset)
...
def ListFeatureClasses(wild_card=..., feature_type=..., feature_dataset=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListDatasets(wild_card=..., feature_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListTables(wild_card=..., table_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListRasters(wild_card=..., raster_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListWorkspaces(wild_card=..., workspace_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListVersions(sde_workspace): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ListUsers(sde_workspace): # -> list[namedtuple]:
...
def DisconnectUser(sde_workspace, users=...): # -> Any:
...
def ListFields(dataset, wild_card=..., field_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
@_gptooldoc(None, [[["FeatureLayer", "Table", "TableView", "Dataset", "FeatureDataset"], "", "", ""]])
def ListIndexes(dataset, wild_card=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
@_gptooldoc(None, [[["FeatureLayer", "Table", "TableView", "Dataset", "FeatureDataset"], "", "", ""]])
def SearchCursor(dataset, where_clause=..., spatial_reference=..., fields=..., sort_fields=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
@_gptooldoc(None, [[["FeatureLayer", "Table", "TableView", "Dataset", "FeatureDataset"], "", "", ""]])
def UpdateCursor(dataset, where_clause=..., spatial_reference=..., fields=..., sort_fields=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
@_gptooldoc(None, [[["FeatureLayer", "Table", "TableView", "Dataset", "FeatureDataset"], "", "", ""]])
def InsertCursor(dataset, spatial_reference=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Describe(value, data_type=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateObject(name, options=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ValidateFieldName(name, workspace=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ValidateTableName(name, workspace=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ParseFieldName(name, workspace=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ParseTableName(name, workspace=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateScratchName(prefix=..., suffix=..., data_type=..., workspace=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateUniqueName(base_name, workspace=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TestSchemaLock(dataset): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateRandomValueGenerator(seed, distribution): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def IsSynchronous(tool_name): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetParameterCount(tool_name): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetParameterValue(tool_name, index): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetParameterInfo(tool_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddFieldDelimiters(datasource, field): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetSeverity(index): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """GetSeverity(index)
...
def FromWKB(byte_array, spatial_reference=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    """FromWKB(byte_array)
...
def FromWKT(wkt_string, spatial_reference=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def FromGeohash(geohash_string): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateGeocodeSDDraft(loc_path, out_sddraft, service_name, server_type=..., connection_file_path=..., copy_data_to_server=..., folder_name=..., summary=..., tags=..., max_result_size=..., max_batch_size=..., suggested_batch_size=..., supported_operations=..., overwrite_existing_service=...):
...
def CreateGPSDDraft(result, out_sddraft, service_name, server_type=..., connection_file_path=..., copy_data_to_server=..., folder_name=..., summary=..., tags=..., executionType=..., resultMapServer=..., showMessages=..., maximumRecords=..., minInstances=..., maxInstances=..., maxUsageTime=..., maxWaitTime=..., maxIdleTime=..., capabilities=..., constantValues=..., choiceLists=...):
...
def CreateImageSDDraft(raster_or_mosaic_layer, out_sddraft, service_name, server_type=..., connection_file_path=..., copy_data_to_server=..., folder_name=..., summary=..., tags=...):
