...
from arcpy.geoprocessing import gptooldoc
from . import Result
...
def Select(
    in_features=..., out_feature_class=..., where_clause=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SplitByAttributes(
    Input_Table=..., Target_Workspace=..., Split_Fields=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TableSelect(
    in_table=..., out_table=..., where_clause=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CountOverlappingFeatures(
    in_features=..., out_feature_class=..., min_overlap_count=..., out_overlap_table=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RemoveOverlapMultiple(
    in_features=..., out_feature_class=..., method=..., join_attributes=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateThiessenPolygons(
    in_features=..., out_feature_class=..., fields_to_copy=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Near(
    in_features: str,
    near_features: str,
    search_radius: str | float | None = ...,
    location: bool | Literal["LOCATION", "NO_LOCATION"] = "NO_LOCATION",
    angle: bool | Literal["ANGLE", "NO_ANGLE"] = "NO_ANGLE",
    method: Literal["PLANAR", "GEODESIC"] = "PLANAR",
...
) -> Result:  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PointDistance(
    in_features=..., near_features=..., out_table=..., search_radius=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Frequency(
    in_table=..., out_table=..., frequency_fields=..., summary_fields=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
