...
def ApplyMasksFromRules(
    in_map=..., rule_file=..., in_feature_dataset=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ApplyVisualSpecificationToMap(
    in_map=..., vs_workspace=..., specification=..., in_style_file=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeMasksFromRules(
    in_map=..., rule_file=..., out_feature_dataset=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CalculateMagneticComponents(
    in_features=..., altitude=..., date=..., magnetic_component=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PopulateMapSheetInfo(
    in_layout=..., area_of_interest=..., lookup_table=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ApplyFeatureLevelMetadata(
    in_features=..., in_metadata_table=..., metadata_favorite=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RemoveCutbackVertices(
    in_features=..., minimum_angle=..., removal_method=..., skip_coincident_vertices=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RepairSelfIntersection(
    in_features=..., repair_type=..., max_length=..., repair_at_end_point=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SplitFeatures(
    cutting_features=..., target_features=..., use_target_z=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def EliminatePolygon(
    in_features=..., surrounding_features=..., min_area=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportGeneralizationData(
    input_geodatabase=..., target_geodatabase=..., rule_file=..., data_theme=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PolygonToCenterline(
    in_features=..., out_feature_class=..., connecting_features=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateCrossReferenceGeodatabase(
    source_workspace=..., target_database=..., out_database=..., mapping_file=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportMetadata(
    in_cell_features=..., export_location=..., metadata_type=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GeoNamesToGeodatabase(
    in_source=..., in_feature_class=..., in_allow_duplicates=..., in_table=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportMetadata(
    files=..., in_cell_features=..., metadata_type=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UnzipCellAndImport(
    Root_Folder=..., Target_Geodatabase=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportTopology(
    in_feature_dataset=..., topology_definition_file=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpdateTaskGroupMetrics(
    job_id=..., status_layer=..., status_field=..., database_path=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def InsertTaskGroup(
    job_id=..., task_group_id=..., database_path=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetTaskStatus(
    job_id=..., parent_id=..., status=..., database_path=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
