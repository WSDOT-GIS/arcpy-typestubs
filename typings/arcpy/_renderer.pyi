...
class UniqueValueRenderer(Base_renderer):
    ...
    useDefaultSymbol = ...
    @property
    def type(self): # -> Literal['UniqueValueRenderer']:
        ...
    
    def listMissingValues(self): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
    
    def removeValues(self, values_or_items): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    ...
    def addValues(self, values_or_items): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
...
class SimpleRenderer(Base_renderer):
    ...
    symbol = ...
    @property
    def type(self): # -> Literal['SimpleRenderer']:
        ...
...
class Graduated_colors_renderer(Base_renderer):
    ...
    deviationInterval = ...
    @property
    def type(self): # -> Literal['GraduatedColorsRenderer']:
        ...
    
    def __repr__(self): # -> Literal['<graduated_colors_renderer object>']:
        ...
...
class Graduated_symbols_renderer(Base_renderer):
    ...
    intervalSize = ...
    deviationInterval = ...
    def updateSymbolTemplate(self, symbol_template): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    ...
    @property
    def type(self): # -> Literal['GraduatedSymbolsRenderer']:
        ...
    
    def __repr__(self): # -> Literal['<graduated_symbols_renderer object>']:
        ...
...
class Unclassed_colors_renderer(Base_renderer):
    ...
    @property
    def type(self): # -> Literal['UnclassedColorsRenderer']:
        ...
    
    def __repr__(self): # -> Literal['<unclassed_colors_renderer object>']:
        ...
