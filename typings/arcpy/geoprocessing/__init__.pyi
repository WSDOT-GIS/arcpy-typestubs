...
def gp_fixargs(
    args, strip_right_nones=..., string_results=..., pass_arc_object=...
):  # -> list[Unknown]:
...
def gp_fixkwargs(
    kwargs, string_results=..., pass_arc_object=...
...
class Geoprocessor:
    ...
    def validateDataStoreItem(
        self, connection_file, datastore_type, connection_name
    ): ...
...
def gptooldoc(toolname: str, toolinfo: Optional[Any] = None) -> Callable[..., Any]:
...
class GPEnvironment:
    autoCommit: int  # = 1000
    XYResolution: Any
    processingServerUser: Any
    gpuId: int  # = 0
    XYDomain: Any
    processingServerPassword: Any
    scratchWorkspace: Any
    recycleProcessingWorkers: Any
    cartographicPartitions: Any
    terrainMemoryUsage: bool  # = False
    MTolerance: Any
    compression: str  # = 'LZ77'
    coincidentPoints: str  # = 'MEAN'
    baUseDetailedAggregation: bool  # = False
    timeZone: Any
    randomGenerator: RandomNumberGenerator  # = 0 ACM599
    outputCoordinateSystem: Any
    rasterStatistics: str  # = 'STATISTICS 1 1'
    transferGDBAttributeProperties: bool  # = False
    ZDomain: Any
    cellSizeProjectionMethod: str  # = 'CONVERT_UNITS'
    maintainCurveSegments: Any
    transferDomains: bool  # = False
    S100FeatureCatalogueFile: Any
    maintainAttachments: bool  # = True
    resamplingMethod: str  # = 'NEAREST'
    snapRaster: Any
    cartographicCoordinateSystem: Any
    baNetworkSource: Any
    configKeyword: Any
    matchMultidimensionalVariable: bool  # = True
    outputZFlag: str  # = 'Same As Input'
    qualifiedFieldNames: bool  # = True
    tileSize: str  # = '128 128'
    annotationTextStringFieldLength: Any
    parallelProcessingFactor: Any
    pyramid: str  # = 'PYRAMIDS -1 NEAREST DEFAULT 75 NO_SKIP NO_SIPS'
    referenceScale: Any
    processingServer: Any
    extent: Any
    unionDimension: bool  # = False
    XYTolerance: Any
    daylightSaving: Any
    tinSaveVersion: str  # = 'CURRENT'
    nodata: str  # = 'NONE'
    MDomain: Any
    cellSize: str  # = 'MAXOF'
    outputZValue: Any
    outputMFlag: str  # = 'Same As Input'
    cellAlignment: str  # = 'DEFAULT'
    geographicTransformations: Any
    ZResolution: Any
    mask: Any
    processorType: Any
    maintainSpatialIndex: bool  # = False
    preserveGlobalIds: bool  # = False
    workspace: Any
    retryOnFailures: Any
    MResolution: Any
    baDataSource: Any
    ZTolerance: Any
    scratchGDB: str  # = 'C:\Users\your-user-name\AppData\Local\Temp\scratch.gdb'
    scratchFolder: str  # = 'C:\Users\your-user-name\AppData\Local\Temp\scratch'
    packageWorkspace: str  # = 'C:\Users\your-user-name\AppData\Local\Temp'
    scriptWorkspace: str  # = 'C:\Users\your-user-name\AppData\Local\Temp'
    addOutputsToMap: bool  # = True
    buildStatsAndRATForTempRaster: bool  # = True

def GPEnvironments(geoprocessor: Geoprocessor) -> GPEnvironment:
    # class GPEnvironment:
    #    ...
    ...
