...
class Variable:
    def __init__(
        self, data_collection, name, alias, units, vintage, percentbase, averagebase
    ) -> None: ...
...
def ListDatasets(): ...
def ListVariables(dataset, include_derivatives=...): ...
def ListGeographyLevels(dataset): ...
def ListStandardGeographies(
    dataset, level=..., query=..., sublevel=..., subquery=...
): ...
