...
class Symbology(_ObjectWithoutInitCallWrapper):
    ...
    _rendererType = ...
    def __new__(cls, wrap_object): # -> Self@Symbology:
        ...
...
class Symbol(_ObjectWithoutInitCall):
    ...
    useRealWorldUnits = ...
    size = ...
    def listSymbolsFromGallery(self, wildcard=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    ...
    def applySymbolFromGallery(self, wildcard, index=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
