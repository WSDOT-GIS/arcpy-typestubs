...
def ConvertMapServerCacheStorageFormat(
    input_service=..., num_of_caching_service_instances=...
...
def GetLayoutTemplatesInfo(
    Layout_Templates_Folder=..., Layout_Item_ID=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def StageService(
    in_service_definition_draft=..., out_service_definition=..., staging_version=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
