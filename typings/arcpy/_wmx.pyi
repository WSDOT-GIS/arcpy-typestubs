...
class Job(_ObjectWithoutInitCall):
    ...
    def getAttachments(self):  # -> list[Attachment]:
        ...
        ...
    def addAttachment(
        self, storage_type, source_location
    ):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    ...
    def retrieveAttachment(
        self, attachment_id, destination_location
    ):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
class WorkflowConnection(_ObjectWithoutInitCall):
    ...
    def getJob(
        ...
        ...
    def createJob(
        self, job_type_id=..., job_type_name=..., job_type_description=..., callback=...
    ):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
    ...
    def createSD(
        ...
        ...
    def queryJobs(
        self, fields, tables, aliases=..., where=..., order_by=...
    ):  # -> QueryResult:
...
class Configuration(_ObjectWithoutInitCall):
    ...
    def getMaps(
        ...
        ...
    def retrieveMap(
        self, map_name, destination_location
    ):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
        ...
        ...
    def storeMap(
        self, map_name, source_location, storage_type=..., overwrite=...
    ):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
         ...
         * False: The link to the map is stored in the Workflow Manager
         database."""
        ...
    def getJobTypeDescription(
        self, job_type_id=..., job_type_name=...
    ):  # -> JobTypeDescription | None:
