...
def AddLevelVariables(
    in_territory_solution=..., level=..., base_level=..., variables=...
...
def SetBalanceVariables(
    in_territory_solution=..., level=..., variables=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetTerritoryAttributeConstraints(
    in_territory_solution=..., level=..., constraints=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CopyTerritorySolution(
    in_territory_solution=..., target_gdb=..., territory_solution_name=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateTerritoryLevelFeatureClasses(
    in_territory_solution=..., level=..., feature_classes=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportTerritorySolution(
    in_territory_solution=..., out_feature_class=..., output_geometry_type=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportTerritorySolution(
    in_data=..., solution_name=..., level_settings=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeTerritorySolutionLayer(
    in_territory_dataset=..., out_territory_solution=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RebuildTerritorySolution(
    in_territory_solution=..., in_boundary_mask=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
