...
def SmoothBathymetricTIN(
    in_tin=..., out_tin=..., depth_direction=..., smoothing_iterations=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateCartographicLimits(
    input_polygons=..., erase_features=..., target_feature_class=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TransferQualityOfPosition(
    in_geodatabase=..., unverified_features_only=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ConvertS57ToS101(
    in_feature_catalogue=..., in_config_file=..., input_s57=..., out_location=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportS100FeatureCatalogue(
    in_feature_catalogue=..., target_workspace=..., admin_connection=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CopyS57Features(
    in_features=..., target_workspace=..., compilation_scale=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportS57ToGeodatabase(
    in_base_cell=..., target_workspace=..., in_update_cells=..., in_product_config=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RepairNauticalData(
    in_workspace=..., repair_operations=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportGeodatabaseToVPF(
    in_source_gdb=..., ntm_date=..., out_location=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportVPFToGeodatabase(
    in_vpf_features=..., target_workspace=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
