...
__all__ = ['AddFieldToAnalysisLayer', 'AddLocations', 'AddVehicleRoutingProblemBreaks', 'AddVehicleRoutingProblemRoutes', 'BuildNetwork', 'CalculateLocations', 'CopyNetworkAnalysisLayer', 'CopyTraversedSourceFeatures', 'CreateNetworkDataset', 'CreateNetworkDatasetFromTemplate', 'CreateTemplateFromNetworkDataset', 'CreateTurnFeatureClass', 'DeleteNetworkAnalysisLayer', 'Directions', 'DissolveNetwork', 'IncreaseMaximumEdges', 'MakeClosestFacilityAnalysisLayer', 'MakeClosestFacilityLayer', 'MakeLocationAllocationAnalysisLayer', 'MakeLocationAllocationLayer', 'MakeNetworkDatasetLayer', 'MakeODCostMatrixAnalysisLayer', 'MakeODCostMatrixLayer', 'MakeRouteAnalysisLayer', 'MakeRouteLayer', 'MakeServiceAreaAnalysisLayer', 'MakeServiceAreaLayer', 'MakeVehicleRoutingProblemAnalysisLayer', 'PopulateAlternateIDFields', 'ShareAsRouteLayers', 'Solve', 'SolveVehicleRoutingProblem', 'TurnTableToTurnFeatureClass', 'UpdateAnalysisLayerAttributeParameter', 'UpdateByAlternateIDFields', 'UpdateByGeometry', 'UpgradeNetwork']
__alias__ = ...
__all__ += _na.__all__
@gptooldoc('AddFieldToAnalysisLayer_na', None)
def AddFieldToAnalysisLayer(in_network_analysis_layer=..., sub_layer=..., field_name=..., field_type=..., field_precision=..., field_scale=..., field_length=..., field_alias=..., field_is_nullable=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddLocations(in_network_analysis_layer=..., sub_layer=..., in_table=..., field_mappings=..., search_tolerance=..., sort_field=..., search_criteria=..., match_type=..., append=..., snap_to_position_along_network=..., snap_offset=..., exclude_restricted_elements=..., search_query=..., allow_auto_relocate=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddVehicleRoutingProblemBreaks(in_vrp_layer=..., target_route=..., break_type=..., time_window_properties=..., travel_time_properties=..., work_time_properties=..., append_to_existing_breaks=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def AddVehicleRoutingProblemRoutes(in_vrp_layer=..., number_of_routes=..., route_name_prefix=..., start_depot_name=..., end_depot_name=..., earliest_start_time=..., latest_start_time=..., max_order_count=..., capacities=..., route_constraints=..., costs=..., additional_route_time=..., append_to_existing_routes=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CalculateLocations(in_point_features=..., in_network_dataset=..., search_tolerance=..., search_criteria=..., match_type=..., source_ID_field=..., source_OID_field=..., position_field=..., side_field=..., snap_X_field=..., snap_Y_field=..., distance_field=..., snap_Z_field=..., location_field=..., exclude_restricted_elements=..., search_query=..., travel_mode=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CopyNetworkAnalysisLayer(in_network_analysis_layer=..., out_layer_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CopyTraversedSourceFeatures(input_network_analysis_layer=..., output_location=..., edge_feature_class_name=..., junction_feature_class_name=..., turn_table_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DeleteNetworkAnalysisLayer(in_network_analysis_layers=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Directions(in_network_analysis_layer=..., file_type=..., out_directions_file=..., report_units=..., report_time=..., time_attribute=..., language=..., style_name=..., stylesheet=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeClosestFacilityAnalysisLayer(network_data_source=..., layer_name=..., travel_mode=..., travel_direction=..., cutoff=..., number_of_facilities_to_find=..., time_of_day=..., time_zone=..., time_of_day_usage=..., line_shape=..., accumulate_attributes=..., generate_directions_on_solve=..., ignore_invalid_locations=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeLocationAllocationAnalysisLayer(network_data_source=..., layer_name=..., travel_mode=..., travel_direction=..., problem_type=..., cutoff=..., number_of_facilities_to_find=..., decay_function_type=..., decay_function_parameter_value=..., target_market_share=..., capacity=..., time_of_day=..., time_zone=..., line_shape=..., accumulate_attributes=..., ignore_invalid_locations=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeODCostMatrixAnalysisLayer(network_data_source=..., layer_name=..., travel_mode=..., cutoff=..., number_of_destinations_to_find=..., time_of_day=..., time_zone=..., line_shape=..., accumulate_attributes=..., ignore_invalid_locations=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeODCostMatrixLayer(in_network_dataset=..., out_network_analysis_layer=..., impedance_attribute=..., default_cutoff=..., default_number_destinations_to_find=..., accumulate_attribute_name=..., UTurn_policy=..., restriction_attribute_name=..., hierarchy=..., hierarchy_settings=..., output_path_shape=..., time_of_day=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeRouteAnalysisLayer(network_data_source=..., layer_name=..., travel_mode=..., sequence=..., time_of_day=..., time_zone=..., line_shape=..., accumulate_attributes=..., generate_directions_on_solve=..., time_zone_for_time_fields=..., ignore_invalid_locations=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeRouteLayer(in_network_dataset=..., out_network_analysis_layer=..., impedance_attribute=..., find_best_order=..., ordering_type=..., time_windows=..., accumulate_attribute_name=..., UTurn_policy=..., restriction_attribute_name=..., hierarchy=..., hierarchy_settings=..., output_path_shape=..., start_date_time=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeServiceAreaAnalysisLayer(network_data_source=..., layer_name=..., travel_mode=..., travel_direction=..., cutoffs=..., time_of_day=..., time_zone=..., output_type=..., polygon_detail=..., geometry_at_overlaps=..., geometry_at_cutoffs=..., polygon_trim_distance=..., exclude_sources_from_polygon_generation=..., accumulate_attributes=..., ignore_invalid_locations=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeServiceAreaLayer(in_network_dataset=..., out_network_analysis_layer=..., impedance_attribute=..., travel_from_to=..., default_break_values=..., polygon_type=..., merge=..., nesting_type=..., line_type=..., overlap=..., split=..., excluded_source_name=..., accumulate_attribute_name=..., UTurn_policy=..., restriction_attribute_name=..., polygon_trim=..., poly_trim_value=..., lines_source_fields=..., hierarchy=..., time_of_day=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeVehicleRoutingProblemAnalysisLayer(network_data_source=..., layer_name=..., travel_mode=..., time_units=..., distance_units=..., default_date=..., time_zone_for_time_fields=..., line_shape=..., time_window_factor=..., excess_transit_factor=..., generate_directions_on_solve=..., spatial_clustering=..., ignore_invalid_locations=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ShareAsRouteLayers(in_network_analysis_layer=..., summary=..., tags=..., route_name_prefix=..., portal_folder_name=..., share_with=..., groups=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def Solve(in_network_analysis_layer=..., ignore_invalids=..., terminate_on_solve_error=..., simplification_tolerance=..., overrides=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpdateAnalysisLayerAttributeParameter(in_network_analysis_layer=..., parameterized_attribute=..., attribute_parameter_name=..., attribute_parameter_value=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def BuildNetwork(in_network_dataset=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateNetworkDataset(feature_dataset=..., out_name=..., source_feature_class_names=..., elevation_model=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateNetworkDatasetFromTemplate(network_dataset_template=..., output_feature_dataset=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateTemplateFromNetworkDataset(network_dataset=..., output_network_dataset_template=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def DissolveNetwork(in_network_dataset=..., out_workspace_location=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def MakeNetworkDatasetLayer(in_network_dataset=..., output_layer=..., draw_elements=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpgradeNetwork(in_network_dataset=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateTurnFeatureClass(out_location=..., out_feature_class_name=..., maximum_edges=..., in_network_dataset=..., in_template_feature_class=..., spatial_reference=..., config_keyword=..., spatial_grid_1=..., spatial_grid_2=..., spatial_grid_3=..., has_z=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def IncreaseMaximumEdges(in_turn_features=..., maximum_edges=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PopulateAlternateIDFields(in_network_dataset=..., alternate_ID_field_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def TurnTableToTurnFeatureClass(in_turn_table=..., reference_line_features=..., out_feature_class_name=..., reference_nodes_table=..., maximum_edges=..., config_keyword=..., spatial_grid_1=..., spatial_grid_2=..., spatial_grid_3=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpdateByAlternateIDFields(in_network_dataset=..., alternate_ID_field_name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpdateByGeometry(in_turn_features=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
