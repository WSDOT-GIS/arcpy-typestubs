...
__all__ = ['ClearJobReplicationInfo', 'CreateJobDataReplica', 'CreateJobs', 'CreateNewJobs', 'CreateWorkflowDatabase', 'ExportJobData', 'GetJobAOI', 'GetJobDataWorkspace', 'GetJobParentVersion', 'GetJobVersion', 'ImportJobData', 'PostJobVersion', 'PublishWorkflowService', 'SynchronizeJobData', 'UpgradeWorkflowDatabase']
__alias__ = ...
__all__ += _wmx.__all__
@gptooldoc('ClearJobReplicationInfo_wmx', None)
def ClearJobReplicationInfo(Input_Repository_URL=..., Input_DatabasePath=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateJobDataReplica(Input_Parent_Repository_URL=..., Input_Parent_Repository_Name=..., Input_Multi_Name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateWorkflowDatabase(Input_Database_Connection=..., AOI_Spatial_Reference=..., Import_Configuration=..., Input_Custom_Configuration=..., User_Store=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ExportJobData(Input_Folder=..., Input_DatabasePath=..., Input_Repository_Name=..., Input_Export_Since=..., Input_Export_Until=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def ImportJobData(Input_File=..., Input_Merge=..., Input_DatabasePath=..., Input_Repository_Name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PublishWorkflowService(service_name=..., aoi_service_name=..., server=..., out_service_draft_location=..., input_database_path=..., server_folder=..., description=..., overwrite=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SynchronizeJobData(Input_Parent_Repository_URL=..., Input_Parent_Repository_Name=..., Input_Multi_Name=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def UpgradeWorkflowDatabase(Input_Database_Connection=..., User_Store=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateJobs(Input_DatabasePath=..., Job_Types=..., Number_of_Jobs=..., Users=..., Priority_of_Jobs=..., Feature_Layer_AOI=..., Union_option=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def CreateNewJobs(Input_DatabasePath=..., Job_Type=..., Number_of_Jobs=..., Assignment_Type=..., Assign_To=..., Priority=..., Feature_Layer_LOI=..., Union=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetJobAOI(Input_JobID=..., aoi_Layer=..., Input_DatabasePath=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetJobDataWorkspace(Input_JobID=..., Input_DatabasePath=..., Input_SDEFileLocation=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetJobParentVersion(Input_JobID=..., Input_DatabasePath=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GetJobVersion(Input_JobID=..., Input_DatabasePath=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def PostJobVersion(Input_JobID=..., Input_DatabasePath=...): # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
