...
def ImportBusinessAnalystReportTemplate(
    online_report_template_id=..., output_folder=..., dataset_id=..., config=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def RemoveSuitabilityCriteria(
    in_analysis_layer=..., drop_criteria=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def SetCriteriaProperties(
    in_analysis_layer=..., criteria_properties=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
...
def GenerateMarketAreaProfile(
    in_features=..., segmentation_base=..., out_profile=...
):  # -> conversion | int | float | complex | basestring | list[Unknown] | tuple[Unknown, ...] | dict[Unknown, Unknown]:
